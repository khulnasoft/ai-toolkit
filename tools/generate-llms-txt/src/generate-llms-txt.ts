...
const exclusionPrefixes = [
  ...
  'docs/02-guides',
  'docs/03-ai-toolkit-core/index',
  'docs/04-ai-toolkit-ui/index',
  'docs/04-ai-toolkit-ui/50-stream-protocol',
  'docs/05-ai-toolkit-rsc',
  'docs/06-advanced',
  'docs/07-reference/index',
  'docs/07-reference/01-ai-toolkit-core',
  'docs/07-reference/02-ai-toolkit-ui',
  'docs/07-reference/03-ai-toolkit-rsc',
  'docs/07-reference/04-stream-helpers',
  'docs/07-reference/05-ai-toolkit-errors/index',
  'docs/08-migration-guides',
  'docs/09-troubleshooting',
  'providers/01-ai-toolkit-providers/index',
