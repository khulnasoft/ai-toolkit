import { ProviderV2, ProviderV3 } from '@ai-toolkit/provider';
...
export function asProviderV3(provider: ProviderV2 | ProviderV3): ProviderV3 {
  ...
  return {
    ...
    embeddingModel: (modelId: string) => asEmbeddingModelV3(v2Provider.textEmbeddingModel(modelId)),
    imageModel: (modelId: string) => asImageModelV3(v2Provider.imageModel(modelId)),
    transcriptionModel: v2Provider.transcriptionModel
      ? (modelId: string) => asTranscriptionModelV3(v2Provider.transcriptionModel!(modelId))
      : undefined,
