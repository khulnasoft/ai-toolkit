...
The **[Together.ai provider](https://ai-toolkit.dev/providers/ai-toolkit-providers/togetherai)** for the [AI SDK](https://ai-toolkit.dev/docs) contains language model support for the [Together.ai](https://together.ai) platform.
