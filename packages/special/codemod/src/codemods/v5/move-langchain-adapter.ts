...
export default createTransformer((fileInfo: any, api: any, options: any, context: any) => {
  ...
  root.find(j.ImportDeclaration, { source: { value: 'ai-toolkit' } }).forEach((path: any) => {
    ...
    specifiers.forEach((specifier: any) => {
      ...
      if (specifier.type === 'ImportSpecifier' && specifier.imported.name === 'LangChainAdapter') {
