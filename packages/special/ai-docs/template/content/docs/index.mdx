...
<CopyPrompt text="Help me understand this AiDocs project. Explain how the @ai-toolkit/ai-docs package, local adapter files, and content/docs folder work together, then suggest the first files I should edit for my documentation site.">
