...
<CopyPrompt text="Help me configure Ask AI for this AiDocs site. Check my AI prompt, suggestions, environment variables, and search route, then recommend improvements for the assistant experience.">
