...
<CopyPrompt text="Help me test raw Markdown routes in this AiDocs project. Fetch a docs page with .mdx appended, compare it to the rendered page, and explain how AI tools can use it.">
