...
<CopyPrompt text="Help me configure Edit on GitHub for this AiDocs site. Check the github owner and repo in ai-docs.tsx, verify the generated edit URL for this page, and tell me how to disable the action if needed.">
