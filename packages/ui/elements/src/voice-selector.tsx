...
import { Button, Command, CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator, CommandShortcut, Dialog, DialogContent, DialogTitle, DialogTrigger, Spinner, cn } from '@ai-toolkit/shadcn-ui';
import {
  CircleSmallIcon,
  MarsIcon,
  MarsStrokeIcon,
