...
- 2e86082: feat(provider/openai): `OpenAIChatLanguageModelOptions` type
  ...
  ```ts
  import { openai, type OpenAIChatLanguageModelOptions } from "@ai-tools/openai";
...
- 1b37b8b9: fix (@ai-tools/openai): only send logprobs settings when logprobs are requested
...
- f9db8fd6: feat (@ai-tools/openai): add parallelToolCalls setting

## 0.0.27

### Patch Changes

- fc9552ec: fix (@ai-tools/azure): allow for nullish delta

## 0.0.26

### Patch Changes

- 7530f861: fix (@ai-tools/openai): add internal dist to bundle

## 0.0.25

### Patch Changes

- 8b1362a7: chore (@ai-tools/openai): expose models under /internal for reuse in other providers

## 0.0.24

### Patch Changes

- 0e78960c: fix (@ai-tools/openai): make function name and arguments nullish

## 0.0.23

### Patch Changes

- a68fe74a: fix (@ai-tools/openai): allow null tool_calls value.
