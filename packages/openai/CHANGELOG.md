...
- 2e86082: feat(provider/openai): `OpenAIChatLanguageModelOptions` type
  ...
  ```ts
  import { openai, type OpenAIChatLanguageModelOptions } from '@ai-toolkit/openai';
...
- 6ed34cb: refactor(openai): consolidate model config into `getResponsesModelConfig()`
  ...
  https://github.com/khulnasoft/ai-toolkit/pull/8038
...
- c9e0f52: Files from the OpenAI Files API are now supported, mirroring functionality of OpenAI Chat and Responses API, respectively. Also, the AI TOOLKIT supports URLs for PDFs in the responses API the same way it did for completions.
...
- 1b37b8b9: fix (@ai-toolkit/openai): only send logprobs settings when logprobs are requested
...
- f9db8fd6: feat (@ai-toolkit/openai): add parallelToolCalls setting

## 0.0.27

### Patch Changes

- fc9552ec: fix (@ai-toolkit/azure): allow for nullish delta

## 0.0.26

### Patch Changes

- 7530f861: fix (@ai-toolkit/openai): add internal dist to bundle

## 0.0.25

### Patch Changes

- 8b1362a7: chore (@ai-toolkit/openai): expose models under /internal for reuse in other providers

## 0.0.24

### Patch Changes

- 0e78960c: fix (@ai-toolkit/openai): make function name and arguments nullish

## 0.0.23

### Patch Changes

- a68fe74a: fix (@ai-toolkit/openai): allow null tool_calls value.
