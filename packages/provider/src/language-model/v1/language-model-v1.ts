...
When the flag is set to `false`, the AI TOOLKIT will download the image and
...
the AI TOOLKIT will download the file and pass the file data to the model.

When undefined, the AI TOOLKIT will download the file.
   */
