...
- 9bed210: ### `extractReasoningMiddleware()`: delay sending `text-start` chunk to prevent rendering final text before reasoning
  ...
  https://github.com/khulnasoft/ai-toolkit/pull/8036
...
- 84e0cc8: Add experimental_StreamData and new opt-in wire protocol to enable streaming additional data. See https://github.com/khulnasoft/ai-toolkit/pull/425.
