...
Stream resumption requires persistence for messages and active streams in your application. The AI TOOLKIT provides tools to connect to storage, but you need to set up the storage yourself.
...
![Diagram showing the architecture and lifecycle of resumable stream requests](https://e742qlubrjnjqpp0.public.blob.ai-storage.com/resume-stream-diagram.png)
...
<br />
<GithubLink link="https://github.com/khulnasoft/ai-toolkit/blob/main/examples/next" />
