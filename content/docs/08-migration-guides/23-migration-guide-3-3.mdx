---
title: Migrate AI TOOLKIT 3.2 to 3.3
description: Learn how to upgrade AI TOOLKIT 3.2 to 3.3.
---

# Migrate AI TOOLKIT 3.2 to 3.3

<Note>
  Check out the [AI TOOLKIT 3.3 release blog
  post](https://khulnasoft.com/blog/vercel-ai-toolkit-3-3) for more information
  about the release.
</Note>
...
introducing significant improvements and new features across the AI TOOLKIT and its associated libraries:

## New Features

### Open Telemetry Support

- Added experimental [OpenTelemetry support](https://sdk.khulnasoft.com/docs/ai-toolkit-core/telemetry#telemetry) for all [AI TOOLKIT Core functions](https://sdk.khulnasoft.com/docs/ai-toolkit-core/overview#ai-toolkit-core-functions), enabling better observability and tracing capabilities.

### AI TOOLKIT UI Improvements
...
- [AWS Bedrock provider](https://sdk.khulnasoft.com/providers/ai-toolkit-providers/amazon-bedrock).
- [Chrome AI provider](https://sdk.khulnasoft.com/providers/community-providers/chrome-ai) (community-maintained).
...
- Vue.js / Nuxt: [Updated examples](https://github.com/khulnasoft/ai-toolkit/tree/main/examples/nuxt-openai) to showcase latest features and best practices.
