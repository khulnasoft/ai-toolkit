...
<Note>
  ...
  post](https://khulnasoft.com/blog/ai-toolkit-4-0) for more information about the
  release.
</Note>
...
The `ai-toolkit` package no longer exports Svelte, Vue, and SolidJS UI integrations.
