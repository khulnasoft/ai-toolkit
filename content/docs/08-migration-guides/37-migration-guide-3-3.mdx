...
- Added experimental [OpenTelemetry support](/docs/ai-toolkit-core/telemetry#telemetry) for all [AI SDK Core functions](/docs/ai-toolkit-core/overview#ai-toolkit-core-functions), enabling better observability and tracing capabilities.
