...
<Note>
  ...
  post](https://vercel.com/blog/vercel-ai-toolkit-3-3) for more information about
  the release.
</Note>
...
- Added experimental [OpenTelemetry support](/docs/ai-toolkit-core/telemetry#telemetry) for all [AI TOOLKIT Core functions](/docs/ai-toolkit-core/overview#ai-toolkit-core-functions), enabling better observability and tracing capabilities.
...
- [AWS Bedrock provider](/providers/ai-toolkit-providers/amazon-bedrock).
