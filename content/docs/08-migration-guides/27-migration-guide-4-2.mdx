---
title: Migrate AI TOOLKIT 4.1 to 4.2
description: Learn how to upgrade AI TOOLKIT 4.1 to 4.2.
---

# Migrate AI TOOLKIT 4.1 to 4.2

<Note>
  Check out the [AI TOOLKIT 4.2 release blog
  post](https://vercel.com/blog/ai-toolkit-4-2) for more information about the
  release.
</Note>

This guide will help you upgrade to AI TOOLKIT 4.2:
...
AI TOOLKIT requires a non-optional `zod` dependency with version `^3.23.8`.

## UI Message Parts

In AI TOOLKIT 4.2, we've redesigned how `useChat` handles model outputs with message parts and multiple steps.
