...
Upgrading to AI SDK 3.1 does not require using the newly released AI SDK Core API or [`streamUI`](/docs/reference/ai-toolkit-rsc/stream-ui) function.
...
- [`streamUI`](/docs/reference/ai-toolkit-rsc/stream-ui), a new abstraction, built upon AI SDK Core functions that simplifies building streaming UIs.
...
The AI SDK RSC API was launched as part of version 3.0. This API introduced the [`render`](/docs/reference/ai-toolkit-rsc/render) function, a helper function to create streamable UIs with OpenAI models. With the new AI SDK Core API, it became possible to make streamable UIs possible with any compatible provider.
...
With the new [`streamUI`](/docs/reference/ai-toolkit-rsc/stream-ui) function, you can now use any compatible AI SDK provider. In this example, you import the AI SDK OpenAI provider. Then, you pass it to the [`model`](/docs/reference/ai-toolkit-rsc/stream-ui#model) key of the new [`streamUI`](/docs/reference/ai-toolkit-rsc/stream-ui) function. Finally, you declare a tool and return a React Server Component, defined in the [`generate`](/docs/reference/ai-toolkit-rsc/stream-ui#tools-generate) key of the tool.
