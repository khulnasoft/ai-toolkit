...
[`@ai-toolkit/codemod`](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/codemod/src/codemods)
repository.
...
<Note>Don't forget to install the new package: `npm install @ai-toolkit/rsc`</Note>
