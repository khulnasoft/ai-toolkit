...
Please use the `streamUI` function instead or [switch to AI SDK UI](/docs/ai-toolkit-rsc/migrating-to-ui).
...
Please use the [AI SDK Core tool calling](/docs/ai-toolkit-core/tools-and-tool-calling) instead.
