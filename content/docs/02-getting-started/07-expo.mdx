...
Install `ai-toolkit`, `@ai-toolkit/react` and `@ai-toolkit/openai`, the AI package, the AI React package and AI TOOLKIT's [ OpenAI provider ](/providers/ai-toolkit-providers/openai) respectively.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    ...
    <Tab>
      <Snippet
        text="npm install ai-toolkit @ai-toolkit/openai @ai-toolkit/react zod"
        dark
      />
    </Tab>
    <Tab>
...
<Note>
  ...
  issue](https://github.com/khulnasoft/ai-toolkit/issues/3946).
</Note>
