...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add @ai-tools/anthropic" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install @ai-tools/anthropic" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add @ai-tools/anthropic" dark />
    </Tab>
    <Tab>
      <Snippet text="bun add @ai-tools/anthropic" dark />
    </Tab>
  </Tabs>
</div>
