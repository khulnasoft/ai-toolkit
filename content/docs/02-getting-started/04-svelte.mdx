...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    <Tab>
      <Snippet
        text="pnpm add -D ai @ai-toolkit/openai @ai-toolkit/svelte zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="npm install -D ai @ai-toolkit/openai @ai-toolkit/svelte zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="yarn add -D ai @ai-toolkit/openai @ai-toolkit/svelte zod"
        dark
      />
    </Tab>
  </Tabs>
