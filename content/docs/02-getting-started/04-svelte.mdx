...
Install `ai` and `@ai-tools/svelte`, the AI package and AI SDK's Svelte bindings. The AI SDK's [ Vercel AI Gateway provider ](/providers/ai-sdk-providers/ai-gateway) ships with the `ai` package. You'll also install `zod`, a schema validation library used for defining tool inputs.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add -D ai @ai-tools/svelte zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install -D ai @ai-tools/svelte zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add -D ai @ai-tools/svelte zod" dark />
    </Tab>
    <Tab>
      <Snippet text="bun add -d ai @ai-tools/svelte zod" dark />
    </Tab>
  </Tabs>
</div>
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add @ai-tools/openai" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install @ai-tools/openai" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add @ai-tools/openai" dark />
    </Tab>

    <Tab>
      <Snippet text="bun add @ai-tools/openai" dark />
    </Tab>
...
## How does `@ai-tools/svelte` differ from `@ai-tools/react`?
...
```svelte
<script>
  import { createAIContext } from '@ai-tools/svelte';
