...
Install `ai` and `@ai-tools/react`, the AI package and AI SDK's React hooks. The AI SDK's [ Vercel AI Gateway provider ](/providers/ai-sdk-providers/ai-gateway) ships with the `ai` package. You'll also install `zod`, a schema validation library used for defining tool inputs.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add ai @ai-tools/react zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install ai @ai-tools/react zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @ai-tools/react zod" dark />
    </Tab>

    <Tab>
      <Snippet text="bun add ai @ai-tools/react zod" dark />
    </Tab>
