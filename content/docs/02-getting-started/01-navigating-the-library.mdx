...
- **[AI SDK Core](/docs/ai-toolkit-core/overview):** A unified, provider agnostic API for generating text, structured objects, and tool calls with LLMs.
- **[AI SDK UI](/docs/ai-toolkit-ui/overview):** A set of framework-agnostic hooks for building chat and generative user interfaces.
- [AI SDK RSC](/docs/ai-toolkit-rsc/overview): Stream generative user interfaces with React Server Components (RSC). Development is currently experimental and we recommend using [AI SDK UI](/docs/ai-toolkit-ui/overview).
...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [AI SDK Core](/docs/ai-toolkit-core/overview) | Call any LLM with unified API (e.g. [generateText](/docs/reference/ai-toolkit-core/generate-text) and [streamText](/docs/reference/ai-toolkit-core/stream-text))                                                 | Any JS environment (e.g. Node.js, Deno, Browser)                   |
| [AI SDK UI](/docs/ai-toolkit-ui/overview)     | Build streaming chat and generative UIs (e.g. [useChat](/docs/reference/ai-toolkit-ui/use-chat))                                                                                                             | React & Next.js, Vue & Nuxt, Svelte & SvelteKit                    |
| [AI SDK RSC](/docs/ai-toolkit-rsc/overview)   | Stream generative UIs from Server to Client (e.g. [streamUI](/docs/reference/ai-toolkit-rsc/stream-ui)). Development is currently experimental and we recommend using [AI SDK UI](/docs/ai-toolkit-ui/overview). | Any framework that supports React Server Components (e.g. Next.js) |
...
| Environment           | [AI SDK Core](/docs/ai-toolkit-core/overview) | [AI SDK UI](/docs/ai-toolkit-ui/overview) | [AI SDK RSC](/docs/ai-toolkit-rsc/overview) |
| --------------------- | ----------------------------------------- | ------------------------------------- | --------------------------------------- |
...
| ---------------------------------------------------------- | ------------------- | ------------------- | ------------------- |
| [useChat](/docs/reference/ai-toolkit-ui/use-chat)              | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| [useChat](/docs/reference/ai-toolkit-ui/use-chat) tool calling | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> |
| [useCompletion](/docs/reference/ai-toolkit-ui/use-completion)  | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| [useObject](/docs/reference/ai-toolkit-ui/use-object)          | <Check size={18} /> | <Cross size={18} /> | <Cross size={18} /> |

<Note>
  [Contributions](https://github.com/khulnasoft/ai-toolkit/blob/main/CONTRIBUTING.md) are
...
- **Re-mounting Issue During Streaming**: when using `createStreamableUI`, components re-mount on `.done()`, causing [flickering](https://github.com/khulnasoft/ai-toolkit/issues/2232).

Given these limitations, **we recommend using [AI SDK UI](/docs/ai-toolkit-ui/overview) for production applications**.
