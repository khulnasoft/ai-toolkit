...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [AI TOOLKIT Core](/docs/ai-toolkit-core/overview) | Call any LLM with unified API (e.g. [generateText](/docs/reference/ai-toolkit-core/generate-text) and [streamText](/docs/reference/ai-toolkit-core/stream-text))                                                 | Any JS environment (e.g. Node.js, Deno, Browser)                   |
| [AI TOOLKIT UI](/docs/ai-toolkit-ui/overview)     | Build streaming chat and generative UIs (e.g. [useChat](/docs/reference/ai-toolkit-ui/use-chat))                                                                                                             | React & Next.js, Vue & Nuxt, Svelte & SvelteKit                    |
...
AI TOOLKIT UI supports the following frameworks: [React](https://react.dev/), [Svelte](https://svelte.dev/), and [Vue.js](https://vuejs.org/). Here is a comparison of the supported functions across these frameworks:
