...
description: Welcome to the AI TOOLKIT quickstart guide for Next.js App Router!
---
...
Install `ai-toolkit`, `@ai-toolkit/react`, and `@ai-toolkit/openai`, the AI package, AI TOOLKIT's React hooks, and AI TOOLKIT's [ OpenAI provider ](/providers/ai-toolkit-providers/openai) respectively.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    <Tab>
      <Snippet
        text="pnpm add ai @ai-toolkit/react @ai-toolkit/openai zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="npm install ai-toolkit @ai-toolkit/react @ai-toolkit/openai zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="yarn add ai @ai-toolkit/react @ai-toolkit/openai zod"
        dark
      />
    </Tab>
  </Tabs>
...
2. Call [`streamText`](/docs/reference/ai-toolkit-core/stream-text), which is imported from the `ai-toolkit` package. This function accepts a configuration object that contains a `model` provider (imported from `@ai-toolkit/openai`) and `messages` (defined in step 1). You can pass additional [settings](/docs/ai-toolkit-core/settings) to further customise the model's behaviour.
