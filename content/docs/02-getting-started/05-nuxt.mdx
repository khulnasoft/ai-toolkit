...
Install `ai` and `@ai-tools/vue`. The Vercel AI Gateway provider ships with the `ai` package.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add ai @ai-tools/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install ai @ai-tools/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @ai-tools/vue zod" dark />
    </Tab>

    <Tab>
      <Snippet text="bun add ai @ai-tools/vue zod" dark />
    </Tab>
