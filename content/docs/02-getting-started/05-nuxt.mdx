---
title: Vue.js (Nuxt)
description: Welcome to the AI TOOLKIT quickstart guide for Vue.js (Nuxt)!
---
...
Install `ai` and `@ai-toolkit/openai`, the AI TOOLKIT's OpenAI provider.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    <Tab>
      <Snippet text="pnpm add ai @ai-toolkit/openai @ai-toolkit/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet
        text="npm install ai @ai-toolkit/openai @ai-toolkit/vue zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @ai-toolkit/openai @ai-toolkit/vue zod" dark />
    </Tab>
  </Tabs>
</div>
...
4. The `streamText` function returns a [`StreamTextResult`](/docs/reference/ai-toolkit-core/stream-text#result). This result object contains the [ `toDataStreamResponse` ](/docs/reference/ai-toolkit-core/stream-text#to-data-stream-response) function which converts the result to a streamed response object.
