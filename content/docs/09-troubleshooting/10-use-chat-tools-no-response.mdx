...
I am using [`useChat`](/docs/reference/ai-toolkit-ui/use-chat).
...
To resolve this issue, convert the incoming messages to the `ModelMessage` format using the [`convertToModelMessages`](/docs/reference/ai-toolkit-ui/convert-to-model-messages) function.
