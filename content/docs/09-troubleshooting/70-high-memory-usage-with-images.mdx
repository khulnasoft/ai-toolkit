...
- [`generateText` API Reference](/docs/reference/ai-toolkit-core/generate-text)
- [`streamText` API Reference](/docs/reference/ai-toolkit-core/stream-text)
