...
- For more details on structured output generation, see [Generating Structured Data](/docs/ai-toolkit-core/generating-structured-data)
- For OpenAI-specific structured output configuration, see [OpenAI Provider - Structured Outputs](/providers/ai-toolkit-providers/openai#structured-outputs)
