...
Update all your `@ai-tools/*` provider packages to compatible version `2.0.0` or later. These versions implement the v2 specification required by AI SDK 5.

```bash
pnpm install ai@latest @ai-tools/openai@latest @ai-tools/anthropic@latest
```

For AI SDK 5 compatibility, you need:

- `ai` package: `5.0.0` or later
- `@ai-tools/*` packages: `2.0.0` or later (for example, `@ai-tools/openai`, `@ai-tools/anthropic`, `@ai-tools/google`)
- `@ai-tools/provider` package: `2.0.0` or later
...
1. Check the provider's package.json for `@ai-tools/provider` peer dependency version `2.0.0` or later
