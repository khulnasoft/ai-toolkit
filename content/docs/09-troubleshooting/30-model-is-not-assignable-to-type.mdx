...
I have updated the AI TOOLKIT and now I get the following error: `Type 'SomeModel' is not assignable to type 'LanguageModelV1'.`
...
Update your provider packages and the AI TOOLKIT to the latest version.
