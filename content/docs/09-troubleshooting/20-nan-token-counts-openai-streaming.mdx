...
I am using `streamText` with the [OpenAI provider for the AI TOOLKIT](/providers/ai-toolkit-providers/openai) and OpenAI models.
I use [`createOpenAI`](/providers/ai-toolkit-providers/openai#provider-instance) to create the provider instance.
...
When you use [`createOpenAI`](/providers/ai-toolkit-providers/openai#provider-instance), you can enable a `strict` compatibility model:
