---
title: Agents
description: An overview of building agents with the AI TOOLKIT.
---

# Agents

The following section shows you how to build agents with the AI TOOLKIT - systems where large language models (LLMs) use tools in a loop to accomplish tasks.
