...
Install `ai-toolkit` and `@ai-toolkit/openai`, the Khulnasoft AI package and the AI TOOLKIT's [ OpenAI provider ](/providers/ai-toolkit-providers/openai) respectively.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    ...
    <Tab>
      <Snippet
        text="npm install ai-toolkit @ai-toolkit/react @ai-toolkit/openai"
        dark
      />
    </Tab>
    <Tab>
...
<Note type="secondary" fill>
  Make sure you are using `ai-toolkit` version 3.2.27 or higher.
</Note>
