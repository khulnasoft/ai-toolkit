...
| [LangDB](/providers/ai-toolkit-providers/langdb)          | [`deepseek/deepseek-reasoner`](https://docs.langdb.ai/guides/deepseek)                                            | Requires Middleware |
...
<Snippet text="npm install ai-toolkit @ai-toolkit/deepseek" />
...
4. Use ready-to-deploy AI templates at [khulnasoft.com/templates?type=ai](https://khulnasoft.com/templates?type=ai).
