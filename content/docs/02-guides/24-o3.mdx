...
<Snippet text="npm install ai-toolkit @ai-toolkit/openai" />
...
3. Check out practical examples at [sdk.khulnasoft.com/examples](/examples) to see the SDK in action and get inspired for your own projects.
4. Dive deeper with advanced guides on topics like Retrieval-Augmented Generation (RAG) and multi-modal chat at [sdk.khulnasoft.com/docs/guides](/docs/guides).
5. Check out ready-to-deploy AI templates at [khulnasoft.com/templates?type=ai](https://khulnasoft.com/templates?type=ai).
