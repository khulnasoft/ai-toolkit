...
To reduce the scope of this guide, you will be starting with a [repository](https://github.com/khulnasoft/ai-toolkit-rag-starter) that already has a few things set up for you:
...
<Snippet
  text={[
    'git clone https://github.com/khulnasoft/ai-toolkit-rag-starter',
...
- Create a free Postgres database with [Khulnasoft Postgres](https://vercel.com/docs/storage/khulnasoft-postgres); or
...
<Note>
  ...
  info](https://github.com/khulnasoft/ai-toolkit-rag-starter/issues/1).
</Note>
