...
At the center of the AI TOOLKIT is [AI TOOLKIT Core](/docs/ai-toolkit-core/overview), which provides a unified API to call any LLM. The code snippet below is all you need to call OpenAI o1-mini with the AI TOOLKIT:
...
<Note>
  To use the o1 series of models, you must either be using @ai-toolkit/openai
...
1. Check out practical examples at [sdk.khulnasoft.com/examples](/examples) to see the SDK in action and get inspired for your own projects.
1. Dive deeper with advanced guides on topics like Retrieval-Augmented Generation (RAG) and multi-modal chat at [sdk.khulnasoft.com/docs/guides](/docs/guides).
1. Check out ready-to-deploy AI templates at [khulnasoft.com/templates?type=ai](https://khulnasoft.com/templates?type=ai).
