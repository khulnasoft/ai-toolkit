...
- [Zod](https://zod.dev)
- [Postgres](https://www.postgresql.org/) with [ Khulnasoft Postgres ](https://vercel.com/postgres)
...
<Note>
  ...
  at the [Khulnasoft Postgres documentation](https://vercel.com/postgres).
</Note>
