...
- [Zod](https://zod.dev)
- [Postgres](https://www.postgresql.org/) with [ Khulnasoft Postgres ](https://khulnasoft.com/postgres)
...
<Note>
  This project uses Khulnasoft Postgres. You can learn more about how to set up at
  the [Khulnasoft Postgres documentation](https://khulnasoft.com/postgres).
</Note>
...
When answering questions about a specific field, ensure you are selecting the identifying column (ie. what is Khulnasoft's valuation would select company and valuation').
