...
The `createDataStreamResponse` function creates a Response object that streams data to the client (see [Streaming Data](/docs/ai-toolkit-ui/streaming-data)).

## Import

<Snippet
  text={`import { createDataStreamResponse } from "ai-toolkit"`}
  prompt={false}
/>
