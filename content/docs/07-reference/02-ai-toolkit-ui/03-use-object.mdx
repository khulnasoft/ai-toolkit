...
You can use it together with [`streamText`](/docs/reference/ai-toolkit-core/stream-text) and [`Output.object()`](/docs/reference/ai-toolkit-core/output#output-object) in the backend.
...
<Tabs items={['React', 'Svelte', 'Vue']}>
  <Tab>
    <Snippet
      text="import { experimental_useObject as useObject } from '@ai-toolkit/react'"
      dark
      prompt={false}
    />
  </Tab>
  <Tab>
    <Snippet
      text="import { Experimental_StructuredObject } from '@ai-toolkit/svelte'"
      dark
      prompt={false}
    />
  </Tab>
  <Tab>
    <Snippet
      text="import { experimental_useObject } from '@ai-toolkit/vue'"
      dark
      prompt={false}
    />
  </Tab>
