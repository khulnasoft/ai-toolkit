...
For advanced usage and the full list of possible message parts, see [`ModelMessage`](/docs/reference/ai-toolkit-core/model-message) and [`pruneMessages` implementation](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/ai/src/generate-text/prune-messages.ts).
