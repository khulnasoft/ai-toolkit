...
- [`InferUITools`](/docs/reference/ai-toolkit-ui/infer-ui-tools) - Infer types for a tool set
- [`ToolUIPart`](/docs/reference/ai-toolkit-ui/tool-ui-part) - Tool part type for UI messages
