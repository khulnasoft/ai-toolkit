...
<Note type="warning">AnthropicStream has been removed in AI TOOLKIT 4.0.</Note>

<Note type="warning">
  AnthropicStream is part of the legacy Anthropic integration. It is not
  compatible with the AI TOOLKIT 3.1 functions. It is recommended to use the [AI
  TOOLKIT Anthropic Provider](/providers/ai-toolkit-providers/anthropic)
  instead.
</Note>
...
<Snippet text={`import { AnthropicStream } from "ai-toolkit"`} prompt={false} />
