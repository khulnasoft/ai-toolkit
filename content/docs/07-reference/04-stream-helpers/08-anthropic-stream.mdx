...
<Note type="warning">
  ...
  compatible with the AI TOOLKIT 3.1 functions. It is recommended to use the [AI TOOLKIT
  Anthropic Provider](/providers/ai-toolkit-providers/anthropic) instead.
</Note>
