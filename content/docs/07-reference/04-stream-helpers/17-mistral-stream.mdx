...
<Note type="warning">MistralStream has been removed in AI TOOLKIT 4.0.</Note>

<Note type="warning">
  MistralStream is part of the legacy Mistral integration. It is not compatible
  with the AI TOOLKIT 3.1 functions. It is recommended to use the [AI TOOLKIT
  Mistral Provider](/providers/ai-toolkit-providers/mistral) instead.
</Note>
...
<Snippet text={`import { MistralStream } from "ai-toolkit"`} prompt={false} />
