...
<Snippet text={`import { tool } from "ai-toolkit"`} prompt={false} />
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'Additional provider-specific metadata. They are passed through to the provider from the AI TOOLKIT and enable provider-specific functionality that can be fully encapsulated in the provider.',
            },
            {
              name: 'type',
              isOptional: true,
