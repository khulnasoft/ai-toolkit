...
<Note>
  You can also pass Zod objects directly to the AI TOOLKIT functions. Internally,
  the AI TOOLKIT will convert the Zod schema to a JSON schema using `zodSchema()`.
