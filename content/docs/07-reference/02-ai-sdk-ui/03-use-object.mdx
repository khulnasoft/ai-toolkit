...
<Tabs items={['React', 'Svelte', 'Vue']}>
  <Tab>
    <Snippet
      text="import { experimental_useObject as useObject } from '@ai-tools/react'"
      dark
      prompt={false}
    />
  </Tab>
  <Tab>
    <Snippet
      text="import { Experimental_StructuredObject } from '@ai-tools/svelte'"
      dark
      prompt={false}
    />
  </Tab>
  <Tab>
    <Snippet
      text="import { experimental_useObject } from '@ai-tools/vue'"
      dark
      prompt={false}
    />
  </Tab>
