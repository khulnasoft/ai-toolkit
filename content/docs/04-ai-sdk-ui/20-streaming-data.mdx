...
<Note>
  ...
  Protocol](/docs/ai-toolkit-ui/stream-protocol#ui-message-stream-protocol).
</Note>
...
Both [message metadata](/docs/ai-toolkit-ui/message-metadata) and data parts allow you to send additional information alongside messages, but they serve different purposes:
...
For more details on message metadata, see the [Message Metadata documentation](/docs/ai-toolkit-ui/message-metadata).
