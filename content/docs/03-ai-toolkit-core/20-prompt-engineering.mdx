...
description: Learn how to develop prompts with AI TOOLKIT Core.
---
...
Not all providers support all AI TOOLKIT features.
...
You can inspect the raw HTTP request bodies for models that expose them, e.g. [OpenAI](/providers/ai-toolkit-providers/openai).
