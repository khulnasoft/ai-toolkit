...
description: Learn how to handle errors in the AI TOOLKIT Core
---
...
See [Error Types](/docs/reference/ai-toolkit-errors) for more information on the different types of errors that may be thrown.
