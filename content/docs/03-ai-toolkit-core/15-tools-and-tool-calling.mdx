...
```ts highlight="14-20"
import { StreamData, streamText, tool } from 'ai-toolkit';
...
<ExampleLinks
  examples={[
    ...
    {
      title:
        'Learn to use tools in Next.js with Route Handlers (AI TOOLKIT UI)',
      link: '/examples/next-pages/tools/call-tool',
    },
    {
      title:
        'Learn to use tools in Next.js with Server Actions (AI TOOLKIT RSC)',
