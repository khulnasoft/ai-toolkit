...
```tsx highlight={"10-12"}
import { experimental_generateVideo as generateVideo } from 'ai';
import { fal, type FalVideoModelOptions } from '@ai-toolkit/fal';
...
| [Kling AI](/providers/ai-toolkit-providers/klingai#video-models)            | `kling-v2.6-t2v`            | Text-to-video                          |
| [Kling AI](/providers/ai-toolkit-providers/klingai#video-models)            | `kling-v2.6-i2v`            | Image-to-video                         |
| [Kling AI](/providers/ai-toolkit-providers/klingai#video-models)            | `kling-v2.6-motion-control` | Motion control                         |
| [Replicate](/providers/ai-toolkit-providers/replicate#video-models)         | `minimax/video-01`          | Text-to-video                          |
| [xAI](/providers/ai-toolkit-providers/xai#video-models)                     | `grok-imagine-video`        | Text-to-video, image-to-video, editing |
