...
- `MockEmbeddingModelV1`: A mock embedding model using the [embedding model v1 specification](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/embedding-model/v1/embedding-model-v1.ts).
- `MockLanguageModelV1`: A mock language model using the [language model v1 specification](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v1/language-model-v1.ts).
