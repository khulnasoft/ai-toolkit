...
<Note>
  ...
  specification](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v1/language-model-v1.ts).
</Note>
...
2. `wrapGenerate`: Wraps the `doGenerate` method of the [language model](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v1/language-model-v1.ts).
   You can modify the parameters, call the language model, and modify the result.
3. `wrapStream`: Wraps the `doStream` method of the [language model](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v1/language-model-v1.ts).
   You can modify the parameters, call the language model, and modify the result.
