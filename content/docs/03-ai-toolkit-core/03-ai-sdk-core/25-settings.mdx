---
title: Settings
description: Learn how to configure the AI TOOLKIT.
---
...
All AI TOOLKIT functions support the following common settings in addition to the model, the [prompt](./prompts), and additional provider-specific settings:
...
<Note>In AI TOOLKIT 5.0, temperature is no longer set to `0` by default.</Note>
...
See the [reasoning guide](/docs/ai-toolkit-core/reasoning) for details on per-provider mapping and migration from `providerOptions`.
