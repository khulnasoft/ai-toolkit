...
[API Reference](/docs/reference/ai-toolkit-core/generate-text#on-finish)
).
...
AI SDK Core provides the [`streamText`](/docs/reference/ai-toolkit-core/stream-text) function which simplifies streaming text from LLMs:
...
The result object contains several helper functions to make the integration into [AI SDK UI](/docs/ai-toolkit-ui) easier:
...
The AI SDK Core provides a [`smoothStream` function](/docs/reference/ai-toolkit-core/smooth-stream) that
