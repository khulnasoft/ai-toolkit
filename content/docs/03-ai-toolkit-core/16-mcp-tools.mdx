...
description: Learn how to connect to Model Context Protocol (MCP) servers and use their tools with AI TOOLKIT Core.
---

# Model Context Protocol (MCP)

The AI TOOLKIT supports connecting to [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) servers to access their tools, resources, and prompts.
...
<Note>
  ...
  documentation](/providers/ai-toolkit-providers/openai#mcp-tool) for details.
</Note>
...
The Stdio transport can be imported from either the MCP SDK or the AI TOOLKIT:

```typescript
import { createMCPClient } from '@ai-toolkit/mcp';
import { StdioClientTransport } from '@modelcontextprotocol/sdk/client/stdio.js';
// Or use the AI TOOLKIT's stdio transport:
// import { Experimental_StdioMCPTransport as StdioClientTransport } from '@ai-toolkit/mcp/mcp-stdio';
...
Authorization via OAuth is supported when using the AI TOOLKIT MCP HTTP or SSE
...
```typescript
import { ElicitationRequestSchema } from '@ai-toolkit/mcp';
