...
Similar to [ AI TOOLKIT Core ](/docs/ai-toolkit-core/overview) APIs (like [ `streamText` ](/docs/reference/ai-toolkit-core/stream-text)), `streamUI` provides a single function to call a model and allow it to respond with React Server Components.
