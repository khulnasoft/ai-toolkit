...
description: Overview of handling loading state with AI TOOLKIT RSC
---
...
There are three approaches you can take to handle loading state with the AI TOOLKIT RSC:
