...
However, regardless of the speed of your model, the AI TOOLKIT is designed to make implementing streaming UIs as simple as possible. In the example below, we stream text generation in under 10 lines of code using the SDK's [`streamText`](/docs/reference/ai-toolkit-core/stream-text) function:
...
For an introduction to streaming UIs and the AI TOOLKIT, check out our [Getting Started guides](/docs/getting-started).
