...
<Note type="warning">
  AI TOOLKIT UI hooks like [`useChat`](/docs/reference/ai-toolkit-ui/use-chat) return
...
<Note type="warning">
  ...
  [OpenAI](/providers/ai-toolkit-providers/openai) (for `wav` and `mp3` audio with
  `gpt-4o-audio-preview`), [Anthropic](/providers/ai-toolkit-providers/anthropic),
