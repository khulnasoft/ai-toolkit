...
You can set text prompts using the `prompt` property made available by AI SDK functions like [`streamText`](/docs/reference/ai-toolkit-core/stream-text) or [`generateText`](/docs/reference/ai-toolkit-core/generate-text).
...
<Note type="warning">
  AI SDK UI hooks like [`useChat`](/docs/reference/ai-toolkit-ui/use-chat) return
