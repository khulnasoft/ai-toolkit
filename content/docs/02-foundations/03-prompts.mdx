...
You can set text prompts using the `prompt` property made available by AI TOOLKIT functions like [`streamText`](/docs/reference/ai-toolkit-core/stream-text) or [`generateText`](/docs/reference/ai-toolkit-core/generate-text).
...
<Note type="warning">
  ...
  recommend using the
  [`convertToModelMessages`](/docs/reference/ai-toolkit-ui/convert-to-model-messages)
