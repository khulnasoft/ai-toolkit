...
- [xAI Grok Provider](/providers/ai-sdk-providers/xai) (`@ai-toolkit/xai`)
- [OpenAI Provider](/providers/ai-sdk-providers/openai) (`@ai-toolkit/openai`)
- [Azure OpenAI Provider](/providers/ai-sdk-providers/azure) (`@ai-toolkit/azure`)
- [Anthropic Provider](/providers/ai-sdk-providers/anthropic) (`@ai-toolkit/anthropic`)
- [Amazon Bedrock Provider](/providers/ai-sdk-providers/amazon-bedrock) (`@ai-toolkit/amazon-bedrock`)
- [Google Generative AI Provider](/providers/ai-sdk-providers/google-generative-ai) (`@ai-toolkit/google`)
- [Google Vertex Provider](/providers/ai-sdk-providers/google-vertex) (`@ai-toolkit/google-vertex`)
- [Mistral Provider](/providers/ai-sdk-providers/mistral) (`@ai-toolkit/mistral`)
- [Together.ai Provider](/providers/ai-sdk-providers/togetherai) (`@ai-toolkit/togetherai`)
- [Cohere Provider](/providers/ai-sdk-providers/cohere) (`@ai-toolkit/cohere`)
- [Fireworks Provider](/providers/ai-sdk-providers/fireworks) (`@ai-toolkit/fireworks`)
- [DeepInfra Provider](/providers/ai-sdk-providers/deepinfra) (`@ai-toolkit/deepinfra`)
- [DeepSeek Provider](/providers/ai-sdk-providers/deepseek) (`@ai-toolkit/deepseek`)
- [Cerebras Provider](/providers/ai-sdk-providers/cerebras) (`@ai-toolkit/cerebras`)
- [Groq Provider](/providers/ai-sdk-providers/groq) (`@ai-toolkit/groq`)
- [Perplexity Provider](/providers/ai-sdk-providers/perplexity) (`@ai-toolkit/perplexity`)
- [ElevenLabs Provider](/providers/ai-sdk-providers/elevenlabs) (`@ai-toolkit/elevenlabs`)
- [LMNT Provider](/providers/ai-sdk-providers/lmnt) (`@ai-toolkit/lmnt`)
- [Hume Provider](/providers/ai-sdk-providers/hume) (`@ai-toolkit/hume`)
- [Rev.ai Provider](/providers/ai-sdk-providers/revai) (`@ai-toolkit/revai`)
- [Deepgram Provider](/providers/ai-sdk-providers/deepgram) (`@ai-toolkit/deepgram`)
- [Gladia Provider](/providers/ai-sdk-providers/gladia) (`@ai-toolkit/gladia`)
- [AssemblyAI Provider](/providers/ai-sdk-providers/assemblyai) (`@ai-toolkit/assemblyai`)
- [Baseten Provider](/providers/ai-sdk-providers/baseten) (`@ai-toolkit/baseten`)
...
Our [language model specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v3) is published as an open-source package, which you can use to create [custom providers](/providers/community-providers/custom-providers).
