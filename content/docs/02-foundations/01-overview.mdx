---
title: Overview
description: An overview of foundational concepts critical to understanding the AI TOOLKIT
---
...
<Note>
  ...
  intelligence (AI) concepts. To dive right into implementing the AI TOOLKIT, feel
...
To effectively leverage the AI TOOLKIT, it helps to familiarize yourself with the following concepts:
...
In the next section, you will learn about the difference between models providers and models, and which ones are available in the AI TOOLKIT.
