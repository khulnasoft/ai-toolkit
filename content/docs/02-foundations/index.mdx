---
title: Foundations
description: A section that covers foundational knowledge around LLMs and concepts crucial to the AI TOOLKIT
---
...
<IndexCards
  cards={[
    ...
    },
    {
      ...
      description:
        'Learn about the providers and models that you can use with the AI TOOLKIT.',
      href: '/docs/foundations/providers-and-models',
    },
    {
      title: 'Prompts',
      description:
        'Learn about how Prompts are used and defined in the AI TOOLKIT.',
      href: '/docs/foundations/prompts',
    },
    {
      title: 'Tools',
      description: 'Learn about tools in the AI TOOLKIT.',
    ...
    {
      title: 'Agents',
      description: 'Learn how to build agents with the AI TOOLKIT.',
      href: '/docs/agents',
    },
  ]}
/>
