...
The [`createStreamableUI`](/docs/reference/ai-sdk-rsc/create-streamable-ui) function belongs to the `@ai-toolkit/rsc` module and creates a stream that can send React components to the client.
