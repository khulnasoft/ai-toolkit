...
In this guide, you will deploy an AI application to [Khulnasoft](https://khulnasoft.com) using [Next.js](https://nextjs.org) (App Router).
...
On the [New Project](https://khulnasoft.com/new) page, under the **Import Git Repository** section, select the Git provider that you would like to import your project from. Follow the prompts to sign in to your GitHub account.
...
You can increase the max duration to 60 seconds on the Hobby Tier. For other tiers, [see the documentation](https://khulnasoft.com/docs/functions/runtimes#max-duration) for limits.
...
Follow [this guide](https://khulnasoft.com/guides/securing-ai-app-rate-limiting) to add rate limiting to your application.
