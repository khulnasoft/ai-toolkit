...
## Rate Limiting with Khulnasoft KV and Upstash Ratelimit

In this example, you will protect an API endpoint using [Khulnasoft KV](https://khulnasoft.com/storage/kv)
...
With Khulnasoft KV and Upstash Ratelimit, it is possible to protect your APIs
