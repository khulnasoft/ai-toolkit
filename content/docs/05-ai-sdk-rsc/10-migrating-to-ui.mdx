...
import { getMutableAIState, streamUI } from '@ai-tools/rsc';
...
import { useActions, useUIState } from '@ai-tools/rsc';
...
```tsx filename="@/app/actions.tsx"
import { z } from 'zod';
import { streamUI } from '@ai-tools/rsc';
import { openai } from '@ai-tools/openai';
...
// link to example implementation: https://github.com/khulnasoft/ai-toolkit-chatbot/blob/00b125378c998d19ef60b73fe576df0fe5a0e9d4/lib/utils.ts#L87-L127
...
import { useObject } from '@ai-tools/react';
import { notificationSchema } from '@/utils/schemas';
