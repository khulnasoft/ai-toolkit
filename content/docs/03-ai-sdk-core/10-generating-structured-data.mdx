...
<ExampleLinks
  examples={[
    ...
    {
      title:
        'Learn to generate structured data in Next.js with Route Handlers (AI TOOLKIT UI)',
      link: '/examples/next-pages/basics/generating-object',
    },
    {
      title:
        'Learn to generate structured data in Next.js with Server Actions (AI TOOLKIT RSC)',
...
<ExampleLinks
  examples={[
    ...
    {
      title:
        'Learn to stream structured data in Next.js with Route Handlers (AI TOOLKIT UI)',
      link: '/examples/next-pages/basics/streaming-object-generation',
    },
    {
      title:
        'Learn to stream structured data in Next.js with Server Actions (AI TOOLKIT RSC)',
