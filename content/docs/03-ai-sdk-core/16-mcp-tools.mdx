...
// import { Experimental_StdioMCPTransport as StdioClientTransport } from '@ai-tools/mcp/mcp-stdio';
...
```typescript
import { createMCPClient, type MCPClient } from '@ai-tools/mcp';
...
```typescript
import { ElicitationRequestSchema } from '@ai-tools/mcp';
