...
The AI SDK provides the [`embed`](/docs/reference/ai-toolkit-core/embed) function to embed single values, which is useful for tasks such as finding similar words
...
The AI SDK provides the [`embedMany`](/docs/reference/ai-toolkit-core/embed-many) function for this purpose.
