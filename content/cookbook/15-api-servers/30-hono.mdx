---
title: Hono
description: Example of using the AI TOOLKIT in a Hono server.
tags: ['api servers', 'streaming']
---

# Hono

You can use the AI TOOLKIT in a [Hono](https://hono.dev/) server to generate and stream text and objects to the client.
...
**Full example**: [github.com/khulnasoft/ai-toolkit/examples/hono](https://github.com/khulnasoft/ai-toolkit/tree/main/examples/hono)
