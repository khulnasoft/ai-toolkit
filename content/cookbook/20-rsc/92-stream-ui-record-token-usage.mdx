...
description: Learn how to record token usage after streaming user interfaces using the AI TOOLKIT and React Server Components
tags: ['rsc', 'usage']
---

# Record Token Usage after Streaming User Interfaces

When you're streaming structured data with [`streamUI`](/docs/reference/ai-toolkit-rsc/stream-ui),
    ...
    tools: {
      deploy: {
        ...
        inputSchema: z.object({
          repositoryName: z
            .string()
            .describe('The name of the repository, example: khulnasoft/ai-chatbot'),
        }),
