...
description: Learn how to call tools in multiple steps using the AI TOOLKIT and Next.js
...
You will use the [`tools`](/docs/reference/ai-toolkit-core/generate-text#tools) parameter to specify two tools called `getLocation` and `getWeather` that will first get the user's location and then use it to get the weather.
