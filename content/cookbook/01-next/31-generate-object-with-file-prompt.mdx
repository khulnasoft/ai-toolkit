...
description: Learn how to generate object with file prompt through form submission using the AI TOOLKIT and Next.js
...
<Note>
  ...
  ([Anthropic](/providers/ai-toolkit-providers/anthropic#pdf-support),
  [OpenAI](/providers/ai-toolkit-providers/openai#pdf-support), [Google
  Gemini](/providers/ai-toolkit-providers/google-generative-ai#file-inputs), and
  [Google Vertex](/providers/ai-toolkit-providers/google-vertex#file-inputs)).
</Note>
...
On the server, create an API route that receives the PDF, sends it to the LLM, and returns the result. This example uses the [ `generateText` ](/docs/reference/ai-toolkit-core/generate-text) function with `Output.object` to generate the summary as part of a structured output.
