...
To see this code in action, check out the [`next-openai` example](https://github.com/khulnasoft/ai/tree/main/examples/next-openai) in the AI TOOLKIT repository. Navigate to the `/use-chat-human-in-the-loop` page and associated route handler.
