...
description: Learn how to generate text with chat prompt using the AI TOOLKIT and Next.js
...
<GithubLink link="https://github.com/khulnasoft/ai/blob/main/examples/next-openai-pages/pages/chat/generate-chat/index.tsx" />
