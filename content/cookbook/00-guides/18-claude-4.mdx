...
description: Get started with Claude 4 using the AI TOOLKIT.
...
The [AI TOOLKIT](/) is a powerful TypeScript toolkit for building AI applications with large language models (LLMs) like Claude 4 alongside popular frameworks like React, Next.js, Vue, Svelte, Node.js, and more.
...
At the center of the AI TOOLKIT is [AI TOOLKIT Core](/docs/ai-toolkit-core/overview), which provides a unified API to call any LLM. The code snippet below is all you need to call Claude 4 Sonnet with the AI TOOLKIT:
...
```ts
import { anthropic, AnthropicLanguageModelOptions } from '@ai-toolkit/anthropic';
import { generateText } from 'ai';
...
Let's explore building a chatbot with [Next.js](https://nextjs.org), the AI TOOLKIT, and Claude Sonnet 4:
