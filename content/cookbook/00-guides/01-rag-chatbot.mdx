...
To reduce the scope of this guide, you will be starting with a [repository](https://github.com/khulnasoft/ai-toolkit-sdk-rag-starter) that already has a few things set up for you:
...
<Snippet
  text={[
    'git clone https://github.com/khulnasoft/ai-toolkit-sdk-rag-starter',
...
<Note>
  The AI TOOLKIT's Vercel AI Gateway Provider is the default global provider, so you
...
The AI TOOLKIT has a feature called [`stopWhen`](/docs/ai-toolkit-core/tools-and-tool-calling#multi-step-calls) which allows stopping conditions when the model generates a tool call. If those stopping conditions haven't been hit, the AI TOOLKIT will automatically send tool call results back to the model!
...
[More info](https://github.com/khulnasoft/ai-toolkit-sdk-rag-starter/issues/1).
