...
description: Get started with OpenAI o3-mini using the AI TOOLKIT.
...
The [AI TOOLKIT](/) is a powerful TypeScript toolkit for building AI applications with large language models (LLMs) like OpenAI o3-mini alongside popular frameworks like React, Next.js, Vue, Svelte, Node.js, and more.
...
At the center of the AI TOOLKIT is [AI TOOLKIT Core](/docs/ai-toolkit-core/overview), which provides a unified API to call any LLM. The code snippet below is all you need to call OpenAI o3-mini with the AI TOOLKIT:
...
<Note>
  To use o3-mini, you must be using @ai-toolkit/openai version 1.1.9 or greater.
</Note>
...
o3-mini supports tool calling out of the box, allowing it to interact with external systems and perform discrete tasks. Here's an example of using tool calling with the AI TOOLKIT:
...
Let's explore building a chatbot with [Next.js](https://nextjs.org), the AI TOOLKIT, and OpenAI o3-mini:
...
2. Check out our support for o3-mini in the [OpenAI Provider](/providers/ai-toolkit-providers/openai#reasoning-models).
3. Check out practical examples at [studio.khulnasoft.com/examples](/examples) to see the SDK in action and get inspired for your own projects.
4. Dive deeper with advanced guides on topics like Retrieval-Augmented Generation (RAG) and multi-modal chat at [studio.khulnasoft.com/docs/guides](/docs/guides).
