...
description: Learn how to build a multi-modal agent that can process images and PDFs with the AI TOOLKIT.
...
You've built a multi-modal AI agent using the AI TOOLKIT! Experiment and extend the functionality of this application further by exploring [tool calling](/docs/ai-toolkit-core/tools-and-tool-calling).
