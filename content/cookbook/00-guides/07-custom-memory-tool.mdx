...
1. **AI TOOLKIT** with `ToolLoopAgent` and `tool`
...
- [AI TOOLKIT documentation](https://ai-toolkit.dev/docs) for `ToolLoopAgent`, `tool`, and `generateText`
- [just-bash](https://github.com/vercel-labs/just-bash) for the JavaScript-based bash interpreter and AST parser
- [AI TOOLKIT examples](https://github.com/khulnasoft/ai-toolkit/tree/main/examples) for more agent patterns
