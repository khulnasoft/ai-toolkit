...
description: Use OpenAI compatible providers with the AI TOOLKIT.
---

# OpenAI Compatible Providers

You can use the [OpenAI Compatible Provider](https://www.npmjs.com/package/@ai-toolkit/openai-compatible) package to use language model providers that implement the OpenAI API.
...
The OpenAI Compatible provider is available via the `@ai-toolkit/openai-compatible` module. You can install it with:
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab>
    <Snippet text="bun add @ai-toolkit/openai-compatible" dark />
  </Tab>
</Tabs>

## Provider Instance

To use an OpenAI compatible provider, you can create a custom provider instance with the `createOpenAICompatible` function from `@ai-toolkit/openai-compatible`:
...
The request body sent to the provider will include the `customOption` field with the value `magic-value`. This gives you an easy way to add provider-specific options to requests without having to modify the provider or AI TOOLKIT code.
