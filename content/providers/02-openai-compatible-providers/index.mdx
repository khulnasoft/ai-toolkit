...
You can use the [OpenAI Compatible Provider](https://www.npmjs.com/package/@ai-tools/openai-compatible) package to use language model providers that implement the OpenAI API.
...
The OpenAI Compatible provider is available via the `@ai-tools/openai-compatible` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/openai-compatible" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/openai-compatible" dark />
  </Tab>
</Tabs>

## Provider Instance

To use an OpenAI compatible provider, you can create a custom provider instance with the `createOpenAICompatible` function from `@ai-tools/openai-compatible`:
...
```typescript
import { MetadataExtractor } from '@ai-tools/openai-compatible';
