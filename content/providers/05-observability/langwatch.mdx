...
![AI TOOLKIT](https://mintlify.s3.us-west-1.amazonaws.com/langwatch/images/integration/vercel-ai-toolkit.png)

### Example Project

You can find a full example project with a more complex pipeline and AI TOOLKIT and LangWatch integration [on our GitHub](https://github.com/langwatch/langwatch/blob/main/typescript-sdk/example/lib/chat/vercel-ai.tsx).
