...
After integrating with the AI TOOLKIT, you can use Weave to view and interact with trace information for your AI TOOLKIT application including prompts, responses, flow, cost and more.
...
- [AI TOOLKIT Telemetry Guide](/docs/ai-toolkit-core/telemetry)
