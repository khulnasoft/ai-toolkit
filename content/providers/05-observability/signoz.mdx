...
Check out more detailed information about Vercel AI TOOLKIT’s telemetry options visit [here](https://ai-toolkit.dev/docs/ai-toolkit-core/telemetry#telemetry).
...
Your Vercel AI TOOLKIT commands should now automatically emit traces, spans, and events. You can find more details on the types of spans and events generated [here](https://ai-toolkit.dev/docs/ai-toolkit-core/telemetry#collected-data).
