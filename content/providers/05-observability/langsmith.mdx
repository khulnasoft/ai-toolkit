...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-tools/openai langsmith" dark />
  </Tab>
</Tabs>
