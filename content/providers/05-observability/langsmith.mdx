...
Install an [AI SDK model provider](/providers/ai-toolkit-providers) and the [LangSmith client SDK](https://npmjs.com/package/langsmith).
The code snippets below will use the [AI SDK's OpenAI provider](/providers/ai-toolkit-providers/openai), but you can use any [other supported provider](/providers/ai-toolkit-providers) as well.
...
const { generateText, streamText } = wrapAITOOLKIT(ai);
...
- [LangSmith guide on tracing with the AI SDK](https://docs.langchain.com/langsmith/trace-with-vercel-ai-toolkit)
