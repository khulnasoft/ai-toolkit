...
<Note>
  ...
  documentation](https://docs.smith.langchain.com/observability/how_to_guides/tracing/trace_with_vercel_ai_toolkit).
</Note>
...
export function register() {
  registerOTel({
    serviceName: 'langsmith-vercel-ai-toolkit-example',
...
- [LangSmith guide on tracing with the AI TOOLKIT](https://docs.smith.langchain.com/observability/how_to_guides/tracing/trace_with_vercel_ai_toolkit)
