...
The AI TOOLKIT supports tracing via OpenTelemetry. With the `LangfuseSpanProcessor` you can collect these traces in Langfuse.
...
```bash
npm install ai @ai-toolkit/openai @langfuse/otel @opentelemetry/sdk-node
```
