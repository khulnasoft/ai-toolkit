...
on the [next-openai](https://github.com/khulnasoft/ai-toolkit/tree/main/examples/next-openai) template to showcase the integration of Langfuse with Next.js and AI SDK.
...
- For more information, see the [telemetry documentation](/docs/ai-toolkit-core/telemetry) of the AI SDK.
