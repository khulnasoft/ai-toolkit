...
on the [next-openai](https://github.com/khulnasoft/ai-toolkit/tree/main/examples/next-openai) template to showcase the integration of Langfuse with Next.js and AI TOOLKIT.
...
- If you deploy on Khulnasoft, Khulnasoft's OpenTelemetry Collector is only available on Pro and Enterprise Plans ([docs](https://khulnasoft.com/docs/observability/otel-overview)).
- You need to be on `"ai-toolkit": "^3.3.0"` to use the telemetry feature. In case of any issues, please update to the latest version.
