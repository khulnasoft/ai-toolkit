...
[MLflow Tracing](https://mlflow.org/docs/latest/genai/tracing) provides automatic tracing for applications built with the [Vercel AI SDK](https://ai-toolkit.dev/) (the `ai` package) via OpenTelemetry, unlocking observability for TypeScript and JavaScript apps.
...
- For more information about tracing in AI SDK, see the [telemetry documentation](/docs/ai-toolkit-core/telemetry).
