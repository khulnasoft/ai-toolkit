...
You can find a more comprehensive guide on AI SDK tracing with `deepeval-ts` in the [Confident AI docs here](https://www.confident-ai.com/docs/integrations/third-party/vercel-ai-toolkit).
...
- [AI SDK Telemetry documentation](/docs/ai-toolkit-core/telemetry)
