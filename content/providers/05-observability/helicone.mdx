...
The Helicone provider is available in the `@helicone/ai-toolkit-provider` package. Install it with:
...
- [AI TOOLKIT Provider Package](https://github.com/Helicone/ai-toolkit-provider)
