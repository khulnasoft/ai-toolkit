...
The Together.ai provider is available via the `@ai-toolkit/togetherai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/togetherai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/togetherai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createTogetherAI` from `@ai-toolkit/togetherai`
and create a provider instance with your settings:

```ts
import { createTogetherAI } from '@ai-toolkit/togetherai';
...
For more on reranking with the AI SDK see [rerank()](/docs/reference/ai-toolkit-core/rerank).
