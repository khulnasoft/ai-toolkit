...
The Together.ai provider is available via the `@ai-tools/togetherai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/togetherai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/togetherai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createTogetherAI` from `@ai-tools/togetherai`
and create a provider instance with your settings:

```ts
import { createTogetherAI } from '@ai-tools/togetherai';
