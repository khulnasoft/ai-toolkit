...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-tools/open-responses" dark />
  </Tab>
</Tabs>
