...
description: Learn how to use the Open Responses provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/open-responses" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-toolkit/open-responses" dark />
  </Tab>
</Tabs>
...
and they support structured data generation with [`Output`](/docs/reference/ai-toolkit-core/output)
