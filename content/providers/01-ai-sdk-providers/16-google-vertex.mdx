...
<Note>
  ...
  The Edge runtime is supported through the `@ai-tools/google-vertex/edge`
...
The Google Vertex and Google Vertex Anthropic providers are both available in the `@ai-tools/google-vertex` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet
      text="yarn add @ai-tools/google-vertex @google-cloud/vertexai"
      dark
    />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/google-vertex" dark />
  </Tab>
</Tabs>
...
You can import the default provider instance `vertex` from `@ai-tools/google-vertex`:

```ts
import { vertex } from '@ai-tools/google-vertex';
```

If you need a customized setup, you can import `createVertex` from `@ai-tools/google-vertex` and create a provider instance with your settings:
...
You can import the default provider instance `vertex` from `@ai-tools/google-vertex/edge`:
...
<Note>
  The `/edge` sub-module is included in the `@ai-tools/google-vertex` package, so
  you don't need to install it separately. You must import from
  `@ai-tools/google-vertex/edge` to differentiate it from the Node.js provider.
</Note>

If you need a customized setup, you can import `createVertex` from `@ai-tools/google-vertex/edge` and create a provider instance with your settings:
...
```ts
import { vertex } from '@ai-tools/google-vertex';
import { GoogleVertexImageModelOptions } from '@ai-tools/google-vertex';
import { generateImage } from 'ai';
...
```ts
import { vertex, GoogleVertexImageModelOptions } from '@ai-tools/google-vertex';
import { generateImage } from 'ai';
import fs from 'fs';
...
```ts
import { vertex } from '@ai-tools/google-vertex';
import { GoogleVertexVideoModelOptions } from '@ai-tools/google-vertex';
import { experimental_generateVideo as generateVideo } from 'ai';
...
You can import the default provider instance `vertexAnthropic` from `@ai-tools/google-vertex/anthropic`:

```typescript
import { vertexAnthropic } from '@ai-tools/google-vertex/anthropic';
```

If you need a customized setup, you can import `createVertexAnthropic` from `@ai-tools/google-vertex/anthropic` and create a provider instance with your settings:
...
For Edge runtimes, you can import the provider instance from `@ai-tools/google-vertex/anthropic/edge`:
...
```typescript
import { createVertexAnthropic } from '@ai-tools/google-vertex/anthropic/edge';
...
<Note>
  ...
  `@ai-tools/anthropic` provider if you need access to all Anthropic tools.
</Note>
