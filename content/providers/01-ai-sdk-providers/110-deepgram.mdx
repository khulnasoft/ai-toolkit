...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/deepgram" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/deepgram" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepgram` from `@ai-tools/deepgram` and create a provider instance with your settings:

```ts
import { createDeepgram } from '@ai-tools/deepgram';
...
```ts highlight="7-11"
import { experimental_generateSpeech as generateSpeech } from 'ai';
import { deepgram, type DeepgramSpeechModelOptions } from '@ai-tools/deepgram';
