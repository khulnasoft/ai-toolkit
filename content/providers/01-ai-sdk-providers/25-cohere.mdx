...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/cohere" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/cohere" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createCohere` from `@ai-tools/cohere`
...
```ts
import { cohere, type CohereLanguageModelOptions } from '@ai-tools/cohere';
import { generateText } from 'ai';
