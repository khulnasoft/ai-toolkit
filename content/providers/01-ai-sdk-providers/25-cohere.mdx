---
title: Cohere
description: Learn how to use the Cohere provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/cohere" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/cohere" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createCohere` from `@ai-toolkit/cohere`
...
```ts
import { cohere, type CohereLanguageModelOptions } from '@ai-toolkit/cohere';
import { generateText } from 'ai';
