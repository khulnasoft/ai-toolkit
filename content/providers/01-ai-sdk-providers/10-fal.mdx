...
The Fal provider is available via the `@ai-tools/fal` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/fal" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/fal" dark />
  </Tab>
</Tabs>
...
```ts
import { createFal } from '@ai-tools/fal';
...
import { fal, type FalTranscriptionModelOptions } from '@ai-tools/fal';
