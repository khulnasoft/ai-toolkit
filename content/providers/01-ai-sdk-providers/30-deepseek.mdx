...
The DeepSeek provider is available via the `@ai-tools/deepseek` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-tools/deepseek" dark />
  </Tab>
</Tabs>
...
```ts
import { createDeepSeek } from '@ai-tools/deepseek';
...
```ts highlight="7-11"
import { deepseek, type DeepSeekLanguageModelOptions } from '@ai-tools/deepseek';
import { generateText } from 'ai';
