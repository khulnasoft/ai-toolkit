...
The Bedrock provider is available in the `@ai-tools/amazon-bedrock` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/amazon-bedrock" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/amazon-bedrock" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAmazonBedrock` from `@ai-tools/amazon-bedrock` and create a provider instance with your settings:
...
```ts
import { type AmazonBedrockLanguageModelOptions } from '@ai-tools/amazon-bedrock';
...
You can import the default provider instance `bedrockAnthropic` from `@ai-tools/amazon-bedrock/anthropic`:

```typescript
import { bedrockAnthropic } from '@ai-tools/amazon-bedrock/anthropic';
```

If you need a customized setup, you can import `createBedrockAnthropic` from `@ai-tools/amazon-bedrock/anthropic` and create a provider instance with your settings:
...
## Migrating to `@ai-tools/amazon-bedrock` 2.x
