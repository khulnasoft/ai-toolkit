...
The Black Forest Labs provider is available via the `@ai-tools/black-forest-labs` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/black-forest-labs" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/black-forest-labs" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/black-forest-labs" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/black-forest-labs" dark />
  </Tab>
</Tabs>
