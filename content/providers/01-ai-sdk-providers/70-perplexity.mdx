---
title: Perplexity
description: Learn how to use Perplexity's Sonar API with the AI TOOLKIT.
---
...
The Perplexity provider is available via the `@ai-toolkit/perplexity` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/perplexity" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/perplexity" dark />
  </Tab>
</Tabs>
...
```ts
import { createPerplexity } from '@ai-toolkit/perplexity';
