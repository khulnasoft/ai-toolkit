...
The Perplexity provider is available via the `@ai-tools/perplexity` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/perplexity" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/perplexity" dark />
  </Tab>
</Tabs>
...
```ts
import { createPerplexity } from '@ai-tools/perplexity';
