...
Cerebras language models can be used in the `streamText` and `streamUI` functions (see [AI TOOLKIT Core](/docs/ai-toolkit-core) and [AI TOOLKIT RSC](/docs/ai-toolkit-rsc)).
