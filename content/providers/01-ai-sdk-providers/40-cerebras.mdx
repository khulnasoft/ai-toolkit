...
The Cerebras provider is available via the `@ai-tools/cerebras` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/cerebras" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/cerebras" dark />
  </Tab>
</Tabs>
...
```ts
import { createCerebras } from '@ai-tools/cerebras';
