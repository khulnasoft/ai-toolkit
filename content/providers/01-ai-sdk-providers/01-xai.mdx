...
The xAI Grok provider is available via the `@ai-tools/xai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/xai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/xai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createXai` from `@ai-tools/xai`
and create a provider instance with your settings:

```ts
import { createXai } from '@ai-tools/xai';
...
```ts
import { xai, type XaiVideoModelOptions } from '@ai-tools/xai';
