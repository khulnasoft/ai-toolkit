...
The Prodia provider is available via the `@ai-tools/prodia` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/prodia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/prodia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/prodia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/prodia" dark />
  </Tab>
</Tabs>
...
```ts
import { prodia, type ProdiaImageModelOptions } from '@ai-tools/prodia';
import { generateImage } from 'ai';
