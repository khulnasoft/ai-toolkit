...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/assemblyai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/assemblyai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAssemblyAI` from `@ai-tools/assemblyai` and create a provider instance with your settings:

```ts
import { createAssemblyAI } from '@ai-tools/assemblyai';
...
import { assemblyai } from '@ai-tools/assemblyai';
import { type AssemblyAITranscriptionModelOptions } from '@ai-tools/assemblyai';
