...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/lmnt" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/lmnt" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createLMNT` from `@ai-tools/lmnt` and create a provider instance with your settings:

```ts
import { createLMNT } from '@ai-tools/lmnt';
...
import { experimental_generateSpeech as generateSpeech } from 'ai';
import { lmnt } from '@ai-tools/lmnt';
import { type LMNTSpeechModelOptions } from '@ai-tools/lmnt';
