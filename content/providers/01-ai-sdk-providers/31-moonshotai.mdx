...
The Moonshot AI provider is available via the `@ai-tools/moonshotai` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/moonshotai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/moonshotai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/moonshotai" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-tools/moonshotai" dark />
  </Tab>
</Tabs>
...
```ts
import { createMoonshotAI } from '@ai-tools/moonshotai';
