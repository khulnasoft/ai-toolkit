...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/hume" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/hume" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createHume` from `@ai-tools/hume` and create a provider instance with your settings:

```ts
import { createHume } from '@ai-tools/hume';
...
import { experimental_generateSpeech as generateSpeech } from 'ai';
import { hume } from '@ai-tools/hume';
import { type HumeSpeechModelOptions } from '@ai-tools/hume';
