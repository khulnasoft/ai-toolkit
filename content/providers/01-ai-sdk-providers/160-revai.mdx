...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/revai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/revai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createRevai` from `@ai-tools/revai` and create a provider instance with your settings:

```ts
import { createRevai } from '@ai-tools/revai';
...
import { revai } from '@ai-tools/revai';
import { type RevaiTranscriptionModelOptions } from '@ai-tools/revai';
