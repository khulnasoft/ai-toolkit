...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/gladia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/gladia" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGladia` from `@ai-tools/gladia` and create a provider instance with your settings:

```ts
import { createGladia } from '@ai-tools/gladia';
...
import { gladia } from '@ai-tools/gladia';
import { type GladiaTranscriptionModelOptions } from '@ai-tools/gladia';
