...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/klingai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/klingai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/klingai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/klingai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createKlingAI` from `@ai-tools/klingai` and create a provider instance with your settings:
...
```ts
import { klingai, type KlingAIVideoModelOptions } from '@ai-tools/klingai';
