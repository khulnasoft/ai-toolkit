...
The Baseten provider is available via the `@ai-tools/baseten` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/baseten" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createBaseten` from `@ai-tools/baseten`
