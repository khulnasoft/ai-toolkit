...
The Hugging Face provider is available via the `@ai-tools/huggingface` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/huggingface" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/huggingface" dark />
  </Tab>
</Tabs>
...
```ts
import { createHuggingFace } from '@ai-tools/huggingface';
