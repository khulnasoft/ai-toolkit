...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/mistral" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/mistral" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createMistral` from `@ai-tools/mistral`
