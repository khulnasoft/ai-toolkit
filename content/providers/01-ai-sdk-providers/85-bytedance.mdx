...
The ByteDance provider is available via the `@ai-tools/bytedance` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/bytedance" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/bytedance" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/bytedance" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/bytedance" dark />
  </Tab>
</Tabs>
