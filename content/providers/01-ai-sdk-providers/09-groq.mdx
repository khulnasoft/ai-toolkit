...
The Groq provider is available via the `@ai-tools/groq` module.
You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/groq" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/groq" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGroq` from `@ai-tools/groq`
and create a provider instance with your settings:

```ts
import { createGroq } from '@ai-tools/groq';
