...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/elevenlabs" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/elevenlabs" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createElevenLabs` from `@ai-tools/elevenlabs` and create a provider instance with your settings:

```ts
import { createElevenLabs } from '@ai-tools/elevenlabs';
