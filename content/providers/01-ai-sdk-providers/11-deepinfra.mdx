...
The DeepInfra provider is available via the `@ai-toolkit/deepinfra` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/deepinfra" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/deepinfra" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepInfra` from `@ai-toolkit/deepinfra` and create a provider instance with your settings:

```ts
import { createDeepInfra } from '@ai-toolkit/deepinfra';
...
DeepInfra language models can also be used in the `streamText` function (see [AI SDK Core](/docs/ai-toolkit-core)).
...
For more on embedding models with the AI SDK see [embed()](/docs/reference/ai-toolkit-core/embed).
