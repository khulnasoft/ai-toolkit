...
The DeepInfra provider is available via the `@ai-tools/deepinfra` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/deepinfra" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/deepinfra" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepInfra` from `@ai-tools/deepinfra` and create a provider instance with your settings:

```ts
import { createDeepInfra } from '@ai-tools/deepinfra';
