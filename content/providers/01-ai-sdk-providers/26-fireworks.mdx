---
title: Fireworks
description: Learn how to use Fireworks models with the AI TOOLKIT.
---
...
The Fireworks provider is available via the `@ai-toolkit/fireworks` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/fireworks" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createFireworks` from `@ai-toolkit/fireworks`
and create a provider instance with your settings:

```ts
import { createFireworks } from '@ai-toolkit/fireworks';
...
Fireworks language models can also be used in the `streamText` and `streamUI` functions (see [AI TOOLKIT Core](/docs/ai-toolkit-core) and [AI TOOLKIT RSC](/docs/ai-toolkit-rsc)).
...
keys and endpoint. The AI TOOLKIT Fireworks provider does not currently include
