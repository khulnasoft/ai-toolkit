...
The Fireworks provider is available via the `@ai-tools/fireworks` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/fireworks" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/fireworks" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createFireworks` from `@ai-tools/fireworks`
and create a provider instance with your settings:

```ts
import { createFireworks } from '@ai-tools/fireworks';
