...
If you need a customized setup, you can import `createAnthropic` from `@ai-tools/anthropic` and create a provider instance with your settings:
...
```ts highlight="8-10"
import { anthropic, AnthropicLanguageModelOptions } from '@ai-tools/anthropic';
import { generateText } from 'ai';
