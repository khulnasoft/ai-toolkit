...
The Luma provider is available via the `@ai-tools/luma` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/luma" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/luma" dark />
  </Tab>
</Tabs>
...
```ts
import { createLuma } from '@ai-tools/luma';
