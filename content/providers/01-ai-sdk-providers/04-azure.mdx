...
The Azure OpenAI provider is available in the `@ai-tools/azure` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/azure" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-tools/azure" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAzure` from `@ai-tools/azure` and create a provider instance with your settings:
...
import { azure, type OpenAILanguageModelResponsesOptions } from '@ai-tools/azure';
...
```ts
import { azure, type OpenAILanguageModelChatOptions } from '@ai-tools/azure';
import { generateText } from 'ai';
...
```ts
import { azure, OpenAILanguageModelResponsesOptions } from '@ai-tools/azure';
import { generateText } from 'ai';
...
```ts
import { azure, type AzureResponsesProviderMetadata } from '@ai-tools/azure';
import { generateText } from 'ai';
...
```ts
import { azure, type OpenAIEmbeddingModelOptions } from '@ai-tools/azure';
...
import { azure, type OpenAITranscriptionModelOptions } from '@ai-tools/azure';
...
```ts
import { azure, type OpenAISpeechModelOptions } from '@ai-tools/azure';
import { experimental_generateSpeech as generateSpeech } from 'ai';
