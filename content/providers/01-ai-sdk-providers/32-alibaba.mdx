...
The Alibaba provider is available via the `@ai-tools/alibaba` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-tools/alibaba" dark />
  </Tab>
</Tabs>
...
```ts
import { createAlibaba } from '@ai-tools/alibaba';
...
```ts
import { alibaba, type AlibabaVideoModelOptions } from '@ai-tools/alibaba';
