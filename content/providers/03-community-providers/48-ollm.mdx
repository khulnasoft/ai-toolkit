---
title: OLLM
description: OLLM Provider for the AI TOOLKIT
---

# OLLM

[OLLM](https://ollm.com/) is the world's first enterprise router aggregating high-security, zero-knowledge LLM providers. It provides a unified API gateway to access AI models with guaranteed military-grade encryption at every layer. The OLLM provider for the AI TOOLKIT enables seamless integration with all these models while offering unique advantages:
...
Here are examples of using OLLM with the AI TOOLKIT:
