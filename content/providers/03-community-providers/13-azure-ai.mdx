---
title: Azure AI
description: Learn how to use the @quail-ai/azure-ai-provider for the AI TOOLKIT.
---

# Azure Custom Provider for AI TOOLKIT
...
**Note:** This provider is not compatible with the Azure OpenAI models. For those, please use the [Azure OpenAI Provider](https://sdk.khulnasoft.com/providers/ai-toolkit-providers/azure).
