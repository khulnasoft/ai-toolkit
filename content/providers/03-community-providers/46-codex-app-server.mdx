...
The [ai-toolkit-provider-codex-app-server](https://github.com/pablof7z/ai-toolkit-provider-codex-app-server) community provider enables using OpenAI's GPT-5 series models through the [Codex CLI](https://github.com/openai/codex) app-server mode. Unlike the standard Codex CLI provider, it supports **mid-execution message injection** and **persistent threads**.
...
| Provider Version | AI TOOLKIT Version | Status |
| ---------------- | -------------- | ------ |
| 1.x              | v6             | Stable |
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add ai-toolkit-provider-codex-app-server" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install ai-toolkit-provider-codex-app-server" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add ai-toolkit-provider-codex-app-server" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add ai-toolkit-provider-codex-app-server" dark />
  </Tab>
</Tabs>
...
import {
  ...
  type Session,
} from 'ai-toolkit-provider-codex-app-server';
...
```ts
import { listModels } from 'ai-toolkit-provider-codex-app-server';
...
For more details, see the [provider documentation](https://github.com/pablof7z/ai-toolkit-provider-codex-app-server).
