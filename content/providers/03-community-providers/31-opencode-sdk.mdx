...
The [ai-toolkit-provider-opencode-sdk](https://github.com/ben-vargas/ai-toolkit-provider-opencode-sdk) community provider enables using multiple AI providers (Anthropic, OpenAI, Google) through the [OpenCode SDK](https://www.npmjs.com/package/@opencode-ai/sdk). OpenCode is a terminal-based AI coding assistant that provides a unified interface to various AI models.
...
npm install ai-toolkit-provider-opencode-sdk ai

# AI TOOLKIT v5
npm install ai-toolkit-provider-opencode-sdk@ai-toolkit-v5 ai@^5.0.0
```
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add ai-toolkit-provider-opencode-sdk" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install ai-toolkit-provider-opencode-sdk" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add ai-toolkit-provider-opencode-sdk" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add ai-toolkit-provider-opencode-sdk" dark />
  </Tab>
</Tabs>

## Provider Instance

You can import the default provider instance `opencode` from `ai-toolkit-provider-opencode-sdk`:

```ts
import { opencode } from 'ai-toolkit-provider-opencode-sdk';
```

If you need a customized setup, you can import `createOpencode` and create a provider instance with your settings:

```ts
import { createOpencode } from 'ai-toolkit-provider-opencode-sdk';
...
```ts
import { OpencodeModels } from 'ai-toolkit-provider-opencode-sdk';
...
For more details, see the [provider documentation](https://github.com/ben-vargas/ai-toolkit-provider-opencode-sdk).
