...
[lgrammel/ai-toolkit-llama-cpp](https://github.com/lgrammel/ai-toolkit-llama-cpp) is a community provider that enables local LLM inference using [llama.cpp](https://github.com/ggerganov/llama.cpp) directly within Node.js via native C++ bindings.
...
The llama.cpp provider is available in the `ai-toolkit-llama-cpp` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add ai-toolkit-llama-cpp" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install ai-toolkit-llama-cpp" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add ai-toolkit-llama-cpp" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add ai-toolkit-llama-cpp" dark />
  </Tab>
</Tabs>
...
You can import `llamaCpp` from `ai-toolkit-llama-cpp` and create a model instance:

```ts
import { llamaCpp } from 'ai-toolkit-llama-cpp';
...
Generate type-safe JSON objects that conform to a schema using [`Output`](/docs/reference/ai-toolkit-core/output):
...
Standard AI TOOLKIT generation parameters are supported:
...
- [GitHub Repository](https://github.com/lgrammel/ai-toolkit-llama-cpp)
- [npm Package](https://www.npmjs.com/package/ai-toolkit-llama-cpp)
