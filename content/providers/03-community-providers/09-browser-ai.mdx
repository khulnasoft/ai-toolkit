---
title: Browser AI
description: Learn how to use browser AI model providers for the AI TOOLKIT.
---

# Browser AI model providers

[jakobhoeg/browser-ai](https://github.com/jakobhoeg/browser-ai) is a community provider that serves as the base AI TOOLKIT provider for client side in-browser AI models.
...
<Note>We support both v5 and v6 of the AI TOOLKIT.</Note>

### Installation

The `@browser-ai/core` (formerly `@built-in-ai`) package is the AI TOOLKIT provider for Chrome and Edge browser's built-in AI models. You can install it with:
...
The `@browser-ai/web-llm` package is the AI TOOLKIT provider for popular open-source models using the WebLLM inference engine. You can install it with:
...
The `@browser-ai/transformers-js` package is the AI TOOLKIT provider for popular open-source models using Transformers.js. You can install it with:
