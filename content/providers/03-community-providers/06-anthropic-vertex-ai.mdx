...
description: Learn how to use the Anthropic Vertex provider for the AI TOOLKIT.
---

# AnthropicVertex Provider

<Note>
  Anthropic for Google Vertex is also support by the [AI TOOLKIT Google Vertex
  provider](/providers/ai-toolkit-providers/google-vertex).
</Note>
...
[nalaso/anthropic-vertex-ai](https://github.com/nalaso/anthropic-vertex-ai) is a community provider that uses Anthropic models through Vertex AI to provide language model support for the AI TOOLKIT.
...
AnthropicVertex language models can also be used in the `streamText` function and support structured data generation with [`Output`](/docs/reference/ai-toolkit-core/output)
(see [AI TOOLKIT Core](/docs/ai-toolkit-core) for more information).
