---
title: Runpod
description: Runpod Provider for the AI TOOLKIT
---
...
The Runpod provider is available in the `@runpod/ai-toolkit-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @runpod/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @runpod/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @runpod/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @runpod/ai-toolkit-provider" dark />
  </Tab>
</Tabs>

## Provider Instance

You can import the default provider instance `runpod` from `@runpod/ai-toolkit-provider`:

```ts
import { runpod } from '@runpod/ai-toolkit-provider';
```

If you need a customized setup, you can import `createRunpod` and create a provider instance with your settings:

```ts
import { createRunpod } from '@runpod/ai-toolkit-provider';
...
Using [`Output`](/docs/reference/ai-toolkit-core/output) to enforce structured output is not supported by two models that are part of this provider.
