...
The [ai-toolkit-provider-gemini-cli](https://github.com/ben-vargas/ai-toolkit-provider-gemini-cli) community provider enables using Google's Gemini models through the [@google/gemini-cli-core](https://www.npmjs.com/package/@google/gemini-cli-core) library. It's useful for developers who want to use their existing Gemini Code Assist subscription or API key authentication.
...
| 1.x              | v5             | `ai-toolkit-v5` | Maintenance |
| 0.x              | v4             | `ai-toolkit-v4` | Legacy      |

```bash
# AI TOOLKIT v6 (default)
npm install ai-toolkit-provider-gemini-cli ai

# AI TOOLKIT v5
npm install ai-toolkit-provider-gemini-cli@ai-toolkit-v5 ai@^5.0.0

# AI TOOLKIT v4
npm install ai-toolkit-provider-gemini-cli@ai-toolkit-v4 ai@^4.0.0
```
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add ai-toolkit-provider-gemini-cli" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install ai-toolkit-provider-gemini-cli" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add ai-toolkit-provider-gemini-cli" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add ai-toolkit-provider-gemini-cli" dark />
  </Tab>
</Tabs>
...
```ts
import { createGeminiProvider } from 'ai-toolkit-provider-gemini-cli';
...
For more details, see the [provider documentation](https://github.com/ben-vargas/ai-toolkit-provider-gemini-cli).
