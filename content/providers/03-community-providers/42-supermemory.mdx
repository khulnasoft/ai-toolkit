---
title: 'Supermemory'
description: 'Learn how to use the Supermemory AI TOOLKIT provider for the Vercel AI TOOLKIT.'
---

# Supermemory

[Supermemory](https://supermemory.ai) is a long-term memory platform that adds persistent, self-growing memory to your AI applications. The Supermemory provider for the AI TOOLKIT enables you to build AI applications with memory that works like the human brain:
...
- **Easy Integration**: Simple setup with existing AI TOOLKIT applications
- **Memory Router**: Direct integration with language model providers
- **Free Tier Available**: Get started with a free API key

Learn more about Supermemory's capabilities in the [Supermemory Documentation](https://supermemory.ai/docs/ai-toolkit/overview).
...
Import and use Supermemory tools with your existing AI TOOLKIT setup:
...
Here are examples of using Supermemory with the AI TOOLKIT:
...
- [Supermemory Documentation](https://supermemory.ai/docs/?ref=ai-toolkit)
- [AI TOOLKIT Integration Cookbook](https://supermemory.ai/docs/cookbook/ai-toolkit-integration)
