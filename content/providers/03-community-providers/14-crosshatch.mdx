---
title: Crosshatch
description: Learn how to use the Crosshatch provider for the AI TOOLKIT.
---
...
It creates language model objects that can be used with the `generateText` and `streamText` functions, and supports structured data generation with [`Output`](/docs/reference/ai-toolkit-core/output).
