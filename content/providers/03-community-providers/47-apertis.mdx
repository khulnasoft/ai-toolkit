---
title: Apertis
description: Apertis AI Provider for the AI TOOLKIT
---
...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @apertis/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @apertis/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @apertis/ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
```ts
import { createApertis } from '@apertis/ai-toolkit-provider';
