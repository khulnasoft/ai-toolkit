---
title: Helicone
description: Helicone Provider for the AI TOOLKIT
---
...
The Helicone provider is available in the `@helicone/ai-toolkit-provider` package. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @helicone/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @helicone/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @helicone/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @helicone/ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
```typescript
import { createHelicone } from '@helicone/ai-toolkit-provider';
...
Here are examples of using Helicone with the AI TOOLKIT.
