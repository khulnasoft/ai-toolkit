...
[Hindsight](https://hindsight.vectorize.io) is a persistent memory service for AI agents. The [`@vectorize-io/hindsight-ai-toolkit`](https://www.npmjs.com/package/@vectorize-io/hindsight-ai-toolkit) package provides five AI SDK-compatible tools that give your agents long-term memory across conversations.
