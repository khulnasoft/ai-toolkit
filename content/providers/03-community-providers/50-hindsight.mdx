---
title: Hindsight
description: Learn how to use Hindsight persistent memory with the AI TOOLKIT.
---

# Hindsight

[Hindsight](https://hindsight.vectorize.io) is a persistent memory service for AI agents. The [`@vectorize-io/hindsight-ai-toolkit`](https://www.npmjs.com/package/@vectorize-io/hindsight-ai-toolkit) package provides five AI TOOLKIT-compatible tools that give your agents long-term memory across conversations.
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet
      text="pnpm add @vectorize-io/hindsight-ai-toolkit @vectorize-io/hindsight-client"
      dark
    />
  </Tab>
  <Tab>
    <Snippet
      text="npm install @vectorize-io/hindsight-ai-toolkit @vectorize-io/hindsight-client"
      dark
    />
  </Tab>
  <Tab>
    <Snippet
      text="yarn add @vectorize-io/hindsight-ai-toolkit @vectorize-io/hindsight-client"
      dark
    />
  </Tab>
  <Tab>
    <Snippet
      text="bun add @vectorize-io/hindsight-ai-toolkit @vectorize-io/hindsight-client"
      dark
    />
  </Tab>
</Tabs>
...
For full API documentation and configuration options, see the [Hindsight documentation](https://hindsight.vectorize.io/sdks/integrations/ai-toolkit).
