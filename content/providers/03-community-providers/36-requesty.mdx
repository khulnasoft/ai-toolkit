---
title: Requesty
description: Requesty Provider for the AI TOOLKIT
---

# Requesty

[Requesty](https://requesty.ai/) is a unified LLM gateway that provides access to over 300 large language models from leading providers like OpenAI, Anthropic, Google, Mistral, AWS, and more. The Requesty provider for the AI TOOLKIT enables seamless integration with all these models while offering enterprise-grade advantages:
...
The Requesty provider is available in the `@requesty/ai-toolkit` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @requesty/ai-toolkit" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @requesty/ai-toolkit" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @requesty/ai-toolkit" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @requesty/ai-toolkit" dark />
  </Tab>
</Tabs>
...
You can import the default provider instance `requesty` from `@requesty/ai-toolkit`:

```typescript
import { requesty } from '@requesty/ai-toolkit';
```
...
Here are examples of using Requesty with the AI TOOLKIT:
...
- [Requesty Provider Repository](https://github.com/requestyai/ai-toolkit-requesty)
