---
title: 'Mem0'
description: 'Learn how to use the Mem0 AI TOOLKIT provider for the AI TOOLKIT.'
---

# Mem0 Provider

The [Mem0 Provider](https://github.com/mem0ai/mem0/tree/main/khulnasoft-ai-toolkit) is a library developed by [**Mem0**](https://mem0.ai)
to integrate with the AI TOOLKIT.
...
<Note type="info">
  🎉 Exciting news! Mem0 AI TOOLKIT now supports <strong>Tools Call</strong>.
</Note>

## Setup

The Mem0 provider is available in the `@mem0/khulnasoft-ai-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @mem0/khulnasoft-ai-provider" dark />
  </Tab>
  
  <Tab>
    <Snippet text="npm install @mem0/khulnasoft-ai-provider" dark />
  </Tab>

  <Tab>
    <Snippet text="yarn add @mem0/khulnasoft-ai-provider" dark />
  </Tab>
</Tabs>
...
```ts
import { createMem0 } from '@mem0/khulnasoft-ai-provider';
...
import { addMemories } from '@mem0/khulnasoft-ai-provider';
...
- For more details on Khulnasoft AI TOOLKIT, visit the [Khulnasoft AI TOOLKIT documentation](https://sdk.khulnasoft.com/docs/introduction).
...
- [Mem0 AI TOOLKIT Docs](https://docs.mem0.ai/integrations/khulnasoft-ai-toolkit#getting-started)
