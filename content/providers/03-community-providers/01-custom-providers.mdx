...
```bash
npm install @ai-tools/provider @ai-tools/provider-utils
```
...
import { ProviderV4 } from '@ai-tools/provider';
...
import { LanguageModelV4, LanguageModelV4CallOptions } from '@ai-tools/provider';
import { postJsonToApi } from '@ai-tools/provider-utils';
...
- Explore the V4 types in detail at [`@ai-tools/provider`](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v4)
