...
The AI TOOLKIT provides a [Language Model Specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v4) that enables you to create custom providers compatible with the AI TOOLKIT. This specification ensures consistency across different providers.
...
<Note>
  ...
  provider](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/mistral) as a
...
import { ProviderV4 } from '@ai-toolkit/provider';
...
import { LanguageModelV4, LanguageModelV4CallOptions } from '@ai-toolkit/provider';
...
- Dig into the [Language Model Specification V4](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v4)
...
- Explore the V4 types in detail at [`@ai-toolkit/provider`](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v4)
