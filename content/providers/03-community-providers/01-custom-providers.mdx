...
The AI TOOLKIT provides a [Language Model Specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v2) that enables you to create custom providers compatible with the AI TOOLKIT. This specification ensures consistency across different providers.
...
import { LanguageModelV3, LanguageModelV3CallOptions } from '@ai-toolkit/provider';
...
- Dig into the [Language Model Specification V3](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v3)
...
- Explore the V2 types in detail at [`@ai-toolkit/provider`](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/V2)
