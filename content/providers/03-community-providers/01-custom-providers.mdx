...
The AI TOOLKIT provides a [Language Model Specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v1).
You can write your own provider that adheres to the specification and it will be compatible with the AI TOOLKIT.

You can find the Language Model Specification in the [AI TOOLKIT repository](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/language-model/v1).
It can be imported from `'@ai-toolkit/provider'`. We also provide utilities that make it easier to implement a custom provider. You can find them in the `@ai-toolkit/provider-utils` package ([source code](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider-utils)).
...
Check out the [Mistral reference implementation](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/mistral)
...
A [language model](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v1/language-model-v1.ts) needs to implement:
...
Check out the [Mistral language model](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/mistral/src/mistral-chat-language-model.ts) as an example.
...
The AI TOOLKIT provides [standardized errors](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider/src/errors) that should be used by providers where possible. This will make it easy for user to debug them.
