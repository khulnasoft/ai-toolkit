---
title: LangDB
description: Learn how to use LangDB with the AI TOOLKIT
---
...
- Enable plug-and-play functionality using any framework like Langchain, Khulnasoft AI TOOLKIT, CrewAI, etc., for easy adoption.
...
The LangDB provider is available via the `@langdb/khulnasoft-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @langdb/khulnasoft-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @langdb/khulnasoft-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @langdb/khulnasoft-provider" dark />
  </Tab>
</Tabs>
...
```tsx
import { createLangDB } from '@langdb/khulnasoft-provider';
