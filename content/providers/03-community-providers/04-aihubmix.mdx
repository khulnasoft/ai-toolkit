---
title: Aihubmix
description: Learn how to use Aihubmix with the AI TOOLKIT.
---
...
The Aihubmix provider is available in the `@aihubmix/ai-toolkit-provider` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @aihubmix/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @aihubmix/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @aihubmix/ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
```typescript
import { createAihubmix } from '@aihubmix/ai-toolkit-provider';
...
```ts
import { aihubmix } from '@aihubmix/ai-toolkit-provider';
```
