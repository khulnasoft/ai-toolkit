...
[Portkey](https://portkey.ai/?utm_source=vercel&utm_medium=docs&utm_campaign=integration) natively integrates with the AI TOOLKIT to make your apps production-ready and reliable. Import Portkey's Vercel package and use it as a provider in your Vercel AI app to enable all of Portkey's features:
...
- Structured output with [`Output`](/docs/reference/ai-toolkit-core/output) is currently not supported.
