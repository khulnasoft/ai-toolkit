...
The `@ai-toolkit/langchain` adapter provides seamless integration between LangChain, LangGraph, and the AI SDK,
...
Then, use the AI SDK's [`useChat`](/docs/ai-toolkit-ui/chatbot) hook in the page component:
...
You can find additional examples in the AI SDK [examples/next-langchain](https://github.com/khulnasoft/ai-toolkit/tree/main/examples/next-langchain) folder.
