...
The `@ai-tools/langchain` adapter provides seamless integration between LangChain, LangGraph, and the AI SDK,
...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-tools/langchain @langchain/core" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-tools/langchain @langchain/core" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-tools/langchain @langchain/core" dark />
  </Tab>
</Tabs>
...
```ts
import { convertModelMessages } from '@ai-tools/langchain';
