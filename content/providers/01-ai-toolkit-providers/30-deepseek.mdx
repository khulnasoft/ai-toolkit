---
title: DeepSeek
description: Learn how to use DeepSeek's models with the AI TOOLKIT.
---
...
The DeepSeek provider is available via the `@ai-toolkit/deepseek` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/deepseek" dark />
  </Tab>
</Tabs>
...
```ts
import { createDeepSeek } from '@ai-toolkit/deepseek';
...
DeepSeek language models can be used in the `streamText` and `streamUI` functions (see [AI TOOLKIT Core](/docs/ai-toolkit-core) and [AI TOOLKIT RSC](/docs/ai-toolkit-rsc)).
