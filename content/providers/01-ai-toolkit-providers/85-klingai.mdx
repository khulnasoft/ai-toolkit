---
title: Kling AI
description: Learn how to use the Kling AI provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/klingai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/klingai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/klingai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/klingai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createKlingAI` from `@ai-toolkit/klingai` and create a provider instance with your settings:
...
For more on video generation with the AI TOOLKIT see [generateVideo()](/docs/reference/ai-toolkit-core/generate-video).
...
```ts
import { klingai, type KlingAIVideoModelOptions } from '@ai-toolkit/klingai';
