...
You can create xAI image models using the `.image()` factory method. For more on image generation with the AI TOOLKIT see [generateImage()](/docs/reference/ai-toolkit-core/generate-image).
