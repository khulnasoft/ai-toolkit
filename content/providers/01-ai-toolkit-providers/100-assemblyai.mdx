---
title: AssemblyAI
description: Learn how to use the AssemblyAI provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/assemblyai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/assemblyai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAssemblyAI` from `@ai-toolkit/assemblyai` and create a provider instance with your settings:

```ts
import { createAssemblyAI } from '@ai-toolkit/assemblyai';
...
import { assemblyai } from '@ai-toolkit/assemblyai';
import { type AssemblyAITranscriptionModelOptions } from '@ai-toolkit/assemblyai';
