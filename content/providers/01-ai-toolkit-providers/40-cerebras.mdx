...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab>
    <Snippet text="bun add @ai-toolkit/cerebras" dark />
  </Tab>
</Tabs>
...
Cerebras offers several reasoning models including `gpt-oss-120b`, `qwen-3-32b`, and `zai-glm-4.7` that generate intermediate thinking tokens before their final response. The reasoning output is streamed through the standard AI TOOLKIT reasoning parts.
