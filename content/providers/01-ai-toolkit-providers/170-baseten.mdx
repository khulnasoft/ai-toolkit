---
title: Baseten
description: Learn how to use Baseten models with the AI TOOLKIT.
---
...
The Baseten provider is available via the `@ai-toolkit/baseten` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/baseten" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createBaseten` from `@ai-toolkit/baseten`
