---
title: DeepInfra
description: Learn how to use DeepInfra's models with the AI TOOLKIT.
---
...
DeepInfra language models can also be used in the `streamText` function (see [AI TOOLKIT Core](/docs/ai-toolkit-core)).
...
For more on embedding models with the AI TOOLKIT see [embed()](/docs/reference/ai-toolkit-core/embed).
