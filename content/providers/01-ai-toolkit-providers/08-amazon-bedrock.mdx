...
The Amazon Bedrock provider for the [AI TOOLKIT](https://sdk.khulnasoft.com/docs) contains language model support for the [Amazon Bedrock](https://aws.amazon.com/bedrock) APIs.
...
Amazon Bedrock models also support some model specific settings that are not part of the [standard call settings](/docs/ai-toolkit-core/settings).
