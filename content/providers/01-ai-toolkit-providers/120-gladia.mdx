---
title: Gladia
description: Learn how to use the Gladia provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/gladia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/gladia" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGladia` from `@ai-toolkit/gladia` and create a provider instance with your settings:

```ts
import { createGladia } from '@ai-toolkit/gladia';
...
import { gladia } from '@ai-toolkit/gladia';
import { type GladiaTranscriptionModelOptions } from '@ai-toolkit/gladia';
