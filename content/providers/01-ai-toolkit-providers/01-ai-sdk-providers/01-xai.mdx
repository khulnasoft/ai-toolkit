...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab>
    <Snippet text="bun add @ai-toolkit/xai" dark />
  </Tab>
</Tabs>
...
You can create xAI image models using the `.image()` factory method. For more on image generation with the AI SDK see [generateImage()](/docs/reference/ai-toolkit-core/generate-image).
...
For more on video generation with the AI SDK see [generateVideo()](/docs/reference/ai-toolkit-core/generate-video).
...
```ts
import { xai, type XaiVideoModelOptions } from '@ai-toolkit/xai';
