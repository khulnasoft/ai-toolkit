---
title: Alibaba
description: Learn how to use Alibaba Cloud Model Studio (Qwen) models with the AI TOOLKIT.
---
...
The Alibaba provider is available via the `@ai-toolkit/alibaba` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/alibaba" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @ai-toolkit/alibaba" dark />
  </Tab>
</Tabs>
...
```ts
import { createAlibaba } from '@ai-toolkit/alibaba';
...
```ts
import { alibaba, type AlibabaVideoModelOptions } from '@ai-toolkit/alibaba';
