...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab>
    <Snippet text="bun add @ai-toolkit/fireworks" dark />
  </Tab>
</Tabs>
...
the [standard call settings](/docs/ai-toolkit-core/settings). You can pass them in the `providerOptions` argument:
