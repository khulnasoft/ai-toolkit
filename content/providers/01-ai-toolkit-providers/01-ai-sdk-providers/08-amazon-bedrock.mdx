...
The Amazon Bedrock provider for the [AI TOOLKIT](/docs) contains language model support for the [Amazon Bedrock](https://aws.amazon.com/bedrock) APIs.

## Setup

The Bedrock provider is available in the `@ai-toolkit/amazon-bedrock` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/amazon-bedrock" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/amazon-bedrock" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAmazonBedrock` from `@ai-toolkit/amazon-bedrock` and create a provider instance with your settings:
...
Amazon Bedrock models also support some model specific provider options that are not part of the [standard call settings](/docs/ai-toolkit-core/settings).
...
```ts
import { type AmazonBedrockLanguageModelOptions } from '@ai-toolkit/amazon-bedrock';
...
be useful for correlating Bedrock API calls with requests made by the AI TOOLKIT:
...
You can import the default provider instance `bedrockAnthropic` from `@ai-toolkit/amazon-bedrock/anthropic`:

```typescript
import { bedrockAnthropic } from '@ai-toolkit/amazon-bedrock/anthropic';
```

If you need a customized setup, you can import `createBedrockAnthropic` from `@ai-toolkit/amazon-bedrock/anthropic` and create a provider instance with your settings:
...
## Migrating to `@ai-toolkit/amazon-bedrock` 2.x
