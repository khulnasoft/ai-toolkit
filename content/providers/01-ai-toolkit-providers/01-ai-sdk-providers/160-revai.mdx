---
title: Rev.ai
description: Learn how to use the Rev.ai provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/revai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/revai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createRevai` from `@ai-toolkit/revai` and create a provider instance with your settings:

```ts
import { createRevai } from '@ai-toolkit/revai';
...
import { revai } from '@ai-toolkit/revai';
import { type RevaiTranscriptionModelOptions } from '@ai-toolkit/revai';
