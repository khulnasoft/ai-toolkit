...
(see [AI SDK Core](/docs/ai-toolkit-core)).
...
using the `.video()` factory method. For more on video generation with the AI SDK see [generateVideo()](/docs/reference/ai-toolkit-core/generate-video).
...
See [AI SDK UI: Chatbot](/docs/ai-toolkit-ui/chatbot#reasoning) for more details
