...
AI Gateway language models can also be used in the `streamText` function and support structured data generation with [`Output`](/docs/reference/ai-toolkit-core/output) (see [AI SDK Core](/docs/ai-toolkit-core)).
...
- Individual [AI SDK provider pages](/providers/ai-toolkit-providers) for specific model capabilities and features
