...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/replicate" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/replicate" dark />
  </Tab>
</Tabs>
...
```ts highlight="9-11"
import { replicate, type ReplicateImageModelOptions } from '@ai-toolkit/replicate';
import { generateImage } from 'ai';
