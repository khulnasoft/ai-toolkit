...
The Hugging Face provider is available via the `@ai-toolkit/huggingface` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/huggingface" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/huggingface" dark />
  </Tab>
</Tabs>
...
```ts
import { createHuggingFace } from '@ai-toolkit/huggingface';
