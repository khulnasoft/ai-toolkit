---
title: ByteDance
description: Learn how to use ByteDance Seedance video models with the AI TOOLKIT.
---
...
The ByteDance provider is available via the `@ai-toolkit/bytedance` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/bytedance" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/bytedance" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/bytedance" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/bytedance" dark />
  </Tab>
</Tabs>
