---
title: Deepgram
description: Learn how to use the Deepgram provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/deepgram" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/deepgram" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepgram` from `@ai-toolkit/deepgram` and create a provider instance with your settings:

```ts
import { createDeepgram } from '@ai-toolkit/deepgram';
...
```ts highlight="7-11"
import { experimental_generateSpeech as generateSpeech } from 'ai';
import { deepgram, type DeepgramSpeechModelOptions } from '@ai-toolkit/deepgram';
