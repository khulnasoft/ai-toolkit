...
The Prodia provider is available via the `@ai-toolkit/prodia` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/prodia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/prodia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/prodia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/prodia" dark />
  </Tab>
</Tabs>
...
```ts
import { prodia, type ProdiaImageModelOptions } from '@ai-toolkit/prodia';
import { generateImage } from 'ai';
