---
title: LMNT
description: Learn how to use the LMNT provider for the AI TOOLKIT.
---
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/lmnt" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/lmnt" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createLMNT` from `@ai-toolkit/lmnt` and create a provider instance with your settings:

```ts
import { createLMNT } from '@ai-toolkit/lmnt';
...
import { experimental_generateSpeech as generateSpeech } from 'ai';
import { lmnt } from '@ai-toolkit/lmnt';
import { type LMNTSpeechModelOptions } from '@ai-toolkit/lmnt';
