---
title: Vercel
description: Learn how to use Vercel's v0 models with the AI TOOLKIT.
---
...
The Vercel provider is available via the `@ai-toolkit/vercel` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @ai-toolkit/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-toolkit/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-toolkit/vercel" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @ai-toolkit/vercel" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createVercel` from `@ai-toolkit/vercel` and create a provider instance with your settings:

```ts
import { createVercel } from '@ai-toolkit/vercel';
...
Vercel language models can also be used in the `streamText` function (see [AI TOOLKIT Core](/docs/ai-toolkit-core)).
