...
def stream_text(messages: List[ClientMessage], protocol: str = 'data'):
    ...
    # https://studio.khulnasoft.com/docs/ai-toolkit-ui/stream-protocol#text-stream-protocol
    ...
    # https://studio.khulnasoft.com/docs/ai-toolkit-ui/stream-protocol#data-stream-protocol
