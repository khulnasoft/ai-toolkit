...
These examples show you how to use the [AI SDK](https://ai-toolkit.dev/docs) with [Next.js](https://nextjs.org) and [FastAPI](https://fastapi.tiangolo.com).
...
- [AI SDK Docs](https://ai-toolkit.dev/docs) - view documentation and reference for the AI SDK.
