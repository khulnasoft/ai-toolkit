...
export default function AgentPage() {
  ...
  return (
    <ChatContainer
      ...
      description={
        <>
          Uses LangChain&apos;s <code>createAgent</code> with <strong>GPT-5</strong> and multiple
          tools including image generation, weather, Wikipedia search, and date/time. GPT-5&apos;s
          reasoning tokens are displayed in a collapsible panel, showing the model&apos;s thought
          process.
        </>
      }
      messages={messages}
