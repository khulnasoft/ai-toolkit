...
const supportItems = [
  {
    ...
    href: 'https://github.com/xeondesk/ai-toolkit/issues/new?template=1.bug_report.yml',
  },
  {
    title: 'Request a Feature',
    description: 'Propose an improvement for the SDK or documentation.',
    href: 'https://github.com/xeondesk/ai-toolkit/issues/new?template=2.feature_request.yml',
  },
  {
    title: 'Ask the Community',
    description: 'Browse discussions and ask implementation questions.',
    href: 'https://github.com/xeondesk/ai-toolkit/discussions',
  },
  {
    title: 'Migration Guides',
    description: 'Upgrade an application between AI TOOLKIT versions.',
