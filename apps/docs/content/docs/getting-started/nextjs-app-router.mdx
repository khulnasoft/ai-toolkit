...
description: Learn how to build your first agent with the AI TOOLKIT and Next.js App Router.
---
...
```tsx title="app/api/chat/route.ts" {2,13-27}
...
```tsx title="app/api/chat/route.ts" {34-47}
import {
  streamText,
  UIMessage,
  convertToModelMessages,
