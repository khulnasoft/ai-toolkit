...
description: Learn how to build your first agent with the AI TOOLKIT and Next.js Pages Router.
---
...
```tsx title="pages/index.tsx" {16-21}
import { useChat } from '@ai-toolkit/react';
import { useState } from 'react';
...
```tsx title="app/api/chat/route.ts" {26-39}
import {
  streamText,
  UIMessage,
  convertToModelMessages,
