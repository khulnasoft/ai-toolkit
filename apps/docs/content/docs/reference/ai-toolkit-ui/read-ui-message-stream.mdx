...
```tsx
import { readUIMessageStream } from 'ai-toolkit';
```
...
For comprehensive examples and use cases, see [Reading UI Message Streams](/docs/ai-toolkit-ui/reading-ui-message-streams).
