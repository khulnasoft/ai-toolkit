...
<Note type="warning">
  ...
  [`generateText`](/docs/reference/ai-toolkit-core/generate-text) with the
  [`output`](/docs/reference/ai-toolkit-core/output) property instead. See
...
<Snippet text={`import { generateObject } from "ai-toolkit"`} prompt={false} />
