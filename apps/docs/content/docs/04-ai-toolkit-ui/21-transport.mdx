...
For scenarios where you want to communicate directly with an [Agent](/docs/reference/ai-toolkit-core/agent) without going through HTTP, you can use `DirectChatTransport`. This transport invokes the agent's `stream()` method directly in-process.
...
For complete API details, see the [DirectChatTransport reference](/docs/reference/ai-toolkit-ui/direct-chat-transport).

## Building Custom Transports

To understand how to build your own transport, refer to the source code of the default implementation:

- **[DefaultChatTransport](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/core/ai/src/ui/default-chat-transport.ts)** - The complete default HTTP transport implementation
- **[HttpChatTransport](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/core/ai/src/ui/http-chat-transport.ts)** - Base HTTP transport with request handling
- **[ChatTransport Interface](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/core/ai/src/ui/chat-transport.ts)** - The transport interface you need to implement
