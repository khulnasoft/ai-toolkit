---
title: Backpressure
description: How to handle backpressure and cancellation when working with the AI TOOLKIT
---


This page focuses on understanding back-pressure and cancellation when working with streams. You do not need to know this information to use the AI TOOLKIT, but for those interested, it offers a deeper dive on why and how the SDK optimally streams responses.
...
{/* When we started writing the streaming code for the AI TOOLKIT, we confirm aborting a fetch will end a streamed response from Next.js */}
