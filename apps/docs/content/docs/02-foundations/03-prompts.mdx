---
title: Prompts
description: Learn about the Prompt structure used in the AI TOOLKIT.
---
...
In order to simplify prompting, the AI TOOLKIT supports text, message, and system prompts.
...
You can set text prompts using the `prompt` property made available by AI TOOLKIT functions like [`streamText`](/docs/reference/ai-toolkit-core/stream-text) or [`generateObject`](/docs/reference/ai-toolkit-core/generate-object).
...
Functions like [`streamText`](/docs/reference/ai-toolkit-core/stream-text#provider-options) or [`generateText`](/docs/reference/ai-toolkit-core/generate-text#provider-options) accept a `providerOptions` property.
...
<Note type="warning">
  AI TOOLKIT UI hooks like [`useChat`](/docs/reference/ai-toolkit-ui/use-chat)
  return arrays of `UIMessage` objects, which do not support provider options.
  We recommend using the
  [`convertToModelMessages`](/docs/reference/ai-toolkit-ui/convert-to-core-messages)
  function to convert `UIMessage` objects to
  [`ModelMessage`](/docs/reference/ai-toolkit-core/model-message) objects before
...
<Note type="warning">
  ...
  Generative AI](/providers/ai-toolkit-providers/google-generative-ai), [Google
  Vertex AI](/providers/ai-toolkit-providers/google-vertex),
  [OpenAI](/providers/ai-toolkit-providers/openai) (for `wav` and `mp3` audio
  with `gpt-4o-audio-preview`),
  [Anthropic](/providers/ai-toolkit-providers/anthropic),
  [OpenAI](/providers/ai-toolkit-providers/openai) (for `pdf`).
</Note>
