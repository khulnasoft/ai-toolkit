...
Our [language model specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/validation/provider/src/language-model/v2) is published as an open-source package, which you can use to create [custom providers](/providers/community-providers/custom-providers).
