...
<Note>
  These utilities can also be paired with [AI TOOLKIT
  Core](/docs/ai-toolkit-core) functions like
  [`streamText`](/docs/reference/ai-toolkit-core/stream-text) and
  [`streamObject`](/docs/reference/ai-toolkit-core/stream-object) to easily
  stream LLM generations from the server to the client.
</Note>
