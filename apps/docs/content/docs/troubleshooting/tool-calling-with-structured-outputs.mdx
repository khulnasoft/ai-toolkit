...
For more information about using structured outputs with `generateText` and `streamText` see [Generating Structured Data](/docs/ai-toolkit-core/generating-structured-data#generating-structured-outputs).
