...
See [Language Model Middleware](/docs/ai-toolkit-core/middleware) for more information on middleware.
...
<Snippet text={`import { wrapLanguageModel } from "ai-toolkit"`} prompt={false} />
