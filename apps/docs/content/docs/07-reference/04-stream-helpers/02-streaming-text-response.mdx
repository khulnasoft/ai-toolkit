...
<Note type="warning">
  `StreamingTextResponse` has been removed in AI TOOLKIT 4.0. Use
  [`streamText.toDataStreamResponse()`](/docs/reference/ai-toolkit-core/stream-text)
  instead.
</Note>
...
<Snippet text={`import { StreamingTextResponse } from "ai-toolkit"`} prompt={false} />
