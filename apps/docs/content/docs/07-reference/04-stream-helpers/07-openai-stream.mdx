...
<Note type="warning">OpenAIStream has been removed in AI TOOLKIT 4.0</Note>
...
<Note type="warning">
  ...
  OpenAI Provider](/providers/ai-toolkit-providers/openai) instead.
</Note>
...
<Snippet text={`import { OpenAIStream } from "ai-toolkit"`} prompt={false} />
