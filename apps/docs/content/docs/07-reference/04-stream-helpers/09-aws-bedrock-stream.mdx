...
<Note type="warning">AWSBedrockStream has been removed in AI TOOLKIT 4.0.</Note>

<Note type="warning">
  AWSBedrockStream is part of the legacy AWS Bedrock integration. It is not
  compatible with the AI TOOLKIT 3.1 functions.
</Note>
...
<Snippet text={`import { AWSBedrockStream } from "ai-toolkit"`} prompt={false} />
