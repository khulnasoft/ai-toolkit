...
<Note type="warning">InkeepStream has been removed in AI TOOLKIT 4.0.</Note>

<Note type="warning">
  InkeepStream is part of the legacy Inkeep integration. It is not compatible
  with the AI TOOLKIT 3.1 functions.
</Note>
...
<Snippet text={`import { InkeepStream } from "ai-toolkit"`} prompt={false} />
