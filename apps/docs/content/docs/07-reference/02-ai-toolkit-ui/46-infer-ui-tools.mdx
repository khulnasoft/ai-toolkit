...
```tsx
import { InferUITools } from 'ai-toolkit';
```
...
- [`InferUITool`](/docs/reference/ai-toolkit-ui/infer-ui-tool) - Infer types for a single tool
- [`useChat`](/docs/reference/ai-toolkit-ui/use-chat) - Chat hook that supports typed tools
