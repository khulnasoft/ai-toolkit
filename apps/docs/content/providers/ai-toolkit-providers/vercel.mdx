...
The Vercel provider is available via the `@ai-toolkit/khulnasoft` module. You can install it with:
...
If you need a customized setup, you can import `createVercel` from `@ai-toolkit/khulnasoft` and create a provider instance with your settings:

```ts
import { createVercel } from '@ai-toolkit/khulnasoft';
