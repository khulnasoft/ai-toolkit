---
title: Clarifai
description: Use Clarifai OpenAI compatible API with the AI TOOLKIT.
---


[Clarifai](https://docs.clarifai.com/getting-started/quickstart) is a platform for building, deploying, and scaling AI-powered applications. It provides a suite of tools and APIs for computer vision, natural language processing, and generative AI. Clarifai offers an OpenAI-compatible API through its full-stack AI development platform, making it easy to integrate powerful AI capabilities using the AI TOOLKIT.

## Setup

The Clarifai provider is available via the `@ai-toolkit/openai-compatible` module as it is compatible with the OpenAI API. You can install it with:
...
To use Clarifai, you can create a custom provider instance with the `createOpenAICompatible` function from `@ai-toolkit/openai-compatible`:
