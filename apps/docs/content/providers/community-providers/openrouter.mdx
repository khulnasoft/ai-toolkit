...
[OpenRouter](https://openrouter.ai/) is a unified API gateway that provides access to hundreds of AI models from leading providers like Anthropic, Google, Meta, Mistral, and more. The OpenRouter provider for the AI TOOLKIT enables seamless integration with all these models while offering unique advantages:
...
The OpenRouter provider is available in the `@openrouter/ai-toolkit-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @openrouter/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @openrouter/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @openrouter/ai-toolkit-provider" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @openrouter/ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
Here are examples of using OpenRouter with the AI TOOLKIT:
...
- [OpenRouter Provider Repository](https://github.com/OpenRouterTeam/ai-toolkit-provider)
