---
title: 'Soniox'
description: 'Learn how to use the Soniox provider for the AI TOOLKIT.'
---


[Soniox provider](https://github.com/soniox/vercel-ai-toolkit-provider) integrates Soniox transcription models with the Vercel AI TOOLKIT.
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @soniox/vercel-ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @soniox/vercel-ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @soniox/vercel-ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @soniox/vercel-ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
```ts
import { soniox } from '@soniox/vercel-ai-toolkit-provider';
...
```ts
import { createSoniox } from '@soniox/vercel-ai-toolkit-provider';
