...
The AI TOOLKIT provides a [Language Model Specification](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/validation/provider/src/language-model/v2) that enables you to create custom providers compatible with the AI TOOLKIT. This specification ensures consistency across different providers.

## Publishing Your Provider

Please publish your custom provider in your own GitHub repository and as an NPM package. You are responsible for hosting and maintaining your provider. Once published, you can submit a PR to the AI TOOLKIT repository to add your provider to the [Community Providers](/providers/community-providers) documentation section. Use the [OpenRouter provider documentation](https://github.com/khulnasoft/ai-toolkit/blob/main/content/providers/03-community-providers/13-openrouter.mdx) as a template for your documentation.
...
The AI TOOLKIT checks these patterns before downloading any URL-based content.
...
```bash
npm install @ai-toolkit/provider @ai-toolkit/provider-utils
```
...
<Note>
  ...
  provider](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/mistral)
...
```ts title="custom-chat-language-model.ts"
import {
  LanguageModelV3,
  LanguageModelV3CallOptions,
} from '@ai-toolkit/provider';
import { postJsonToApi } from '@ai-toolkit/provider-utils';
...
class CustomChatLanguageModel implements LanguageModelV3 {
  ...
  // Convert AI TOOLKIT prompt to provider format
  ...
  async doGenerate(options: LanguageModelV3CallOptions) {
    ...
    // Convert provider response to AI TOOLKIT format
  ...
  async doStream(options: LanguageModelV3CallOptions) {
    ...
    // Transform stream to AI TOOLKIT format
...
Map AI TOOLKIT messages to your provider's format:

```ts title="custom-chat-language-model.ts#L50-100"
...
Create a streaming transformer that converts provider chunks to AI TOOLKIT stream parts:

```ts title="custom-chat-language-model.ts#L150-200"
...
Use standardized AI TOOLKIT errors for consistent error handling:

```ts title="custom-chat-language-model.ts#L250-280"
import {
  APICallError,
...
- Dig into the [Language Model Specification V3](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/validation/provider/src/language-model/v3)
- Check out the [Mistral provider](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/mistral) reference implementation
- Check out [provider utilities](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/provider-utils) for helpful functions
- Test your provider with the AI TOOLKIT's built-in examples
- Explore the V2 types in detail at [`@ai-toolkit/provider`](https://github.com/khulnasoft/ai-toolkit/tree/main/packages/validation/provider/src/language-model/V2)
