---
title: Dify
description: Learn how to use the Dify provider for the AI TOOLKIT.
---


The **[Dify provider](https://github.com/warmwind/dify-ai-provider)** allows you to easily integrate Dify's application workflow with your applications using the AI TOOLKIT.
