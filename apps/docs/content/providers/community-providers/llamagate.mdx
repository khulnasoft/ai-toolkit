---
title: LlamaGate
description: LlamaGate Provider for the AI TOOLKIT
---
...
The LlamaGate provider is available in the `@llamagate/ai-toolkit-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @llamagate/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @llamagate/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @llamagate/ai-toolkit-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @llamagate/ai-toolkit-provider" dark />
  </Tab>
</Tabs>
...
```typescript
import { llamagate } from '@llamagate/ai-toolkit-provider';
```
...
Here are examples of using LlamaGate with the AI TOOLKIT:
