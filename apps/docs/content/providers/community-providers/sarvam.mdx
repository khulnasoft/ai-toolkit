---
title: 'Sarvam'
description: 'Learn how to use the Sarvam AI provider for the AI TOOLKIT.'
---


The Sarvam AI Provider is a library developed to integrate with the AI TOOLKIT. This library brings Speech to Text (STT) capabilities to your applications, allowing for seamless interaction with audio and text data.
