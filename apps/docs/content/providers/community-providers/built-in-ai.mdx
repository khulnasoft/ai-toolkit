---
title: Built-in AI
description: Learn how to use the Built-in AI provider (browser models) for the AI TOOLKIT.
---


[jakobhoeg/built-in-ai](https://github.com/jakobhoeg/built-in-ai) is a community provider that serves as the base AI TOOLKIT provider for client side in-browser AI models.
...
The `@built-in-ai/core` package is the AI TOOLKIT provider for Chrome and Edge browser's built-in AI models. You can install it with:
...
The `@built-in-ai/web-llm` package is the AI TOOLKIT provider for popular open-source models using the WebLLM inference engine. You can install it with:
...
The `@built-in-ai/transformers-js` package is the AI TOOLKIT provider for popular open-source models using Transformers.js. You can install it with:
