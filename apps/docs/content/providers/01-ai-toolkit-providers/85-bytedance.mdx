---
title: ByteDance
description: Learn how to use ByteDance Seedance video and Seedream image models with the AI TOOLKIT.
---
...
<InstallPackages packages="@ai-toolkit/bytedance" />
...
<Note>
  ...
  through the AI TOOLKIT integration.
</Note>
...
option of [`generateVideo()`](/docs/reference/ai-toolkit-core/generate-video):
