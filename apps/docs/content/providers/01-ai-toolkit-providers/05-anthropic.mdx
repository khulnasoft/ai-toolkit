---
title: Anthropic
description: Learn how to use the Anthropic provider for the AI TOOLKIT.
---
...
If you need a customized setup, you can import `createAnthropic` from `@ai-toolkit/anthropic` and create a provider instance with your settings:
