---
title: Together.ai
description: Learn how to use Together.ai's models with the AI TOOLKIT.
---
...
For more on reranking with the AI TOOLKIT see [rerank()](/docs/reference/ai-toolkit-core/rerank).
