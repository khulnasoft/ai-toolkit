---
title: Patronus
description: Monitor, evaluate and debug your AI TOOLKIT application with Patronus
---
...
When you build with the AI TOOLKIT, you can stream OpenTelemetry (OTEL) traces straight into Patronus and pair every generation with rich automatic evaluations.
...
The AI TOOLKIT emits a span only when you opt in with `experimental_telemetry`:
