...
After integrating with the AI TOOLKIT, you can use Scorecard to trace, monitor, and analyze your LLM providers, prompts, and application flows.

## Setup

Scorecard supports [AI TOOLKIT telemetry data](/docs/ai-toolkit-core/telemetry).
...
To use the AI TOOLKIT to send telemetry data to Scorecard, first set these environment variables in your project:
...
- **LLM call traces**: Detailed information about each AI TOOLKIT call
