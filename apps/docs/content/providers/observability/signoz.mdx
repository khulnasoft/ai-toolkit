---
title: SigNoz
description: Monitor, obeserve and debug your AI TOOLKIT application with SigNoz
---
...
## Enable Telemetry for Vercel AI TOOLKIT

The Vercel AI TOOLKIT uses [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) to collect telemetry data. OpenTelemetry is an open-source observability framework designed to provide standardized instrumentation for collecting telemetry data.

## Enabling Telemetry

Check out more detailed information about Vercel AI TOOLKIT’s telemetry options visit [here](https://studio.khulnasoft.com/docs/ai-toolkit-core/telemetry#telemetry).
...
const result = await generateText({
  ...
  experimental_telemetry: {
    isEnabled: true,
    tracer: tracerProvider.getTracer('ai-toolkit'),
  },
});
```

Your Vercel AI TOOLKIT commands should now automatically emit traces, spans, and events. You can find more details on the types of spans and events generated [here](https://studio.khulnasoft.com/docs/ai-toolkit-core/telemetry#collected-data).
