---
title: Axiom
description: Measure, observe, and improve your AI TOOLKIT application with Axiom
---
...
Axiom’s integration with the AI TOOLKIT uses a model wrapper to automatically capture detailed traces for every LLM call, giving you immediate visibility into your application's performance, cost, and behavior.
...
In your application code, import `wrapAITOOLKITModel` from Axiom and use it to wrap your existing AI TOOLKIT model client.

```typescript
import { createOpenAI } from '@ai-toolkit/openai';
import { generateText } from 'ai-toolkit';
import { wrapAITOOLKITModel } from 'axiom/ai';
...
const tracedGpt4o = wrapAITOOLKITModel(openaiProvider('gpt-4o'));
...
Axiom’s AI TOOLKIT offers more advanced instrumentation for deeper visibility:
...
To learn more about these features, see the [Axiom AI TOOLKIT Instrumentation guide](https://axiom.co/docs/ai-engineering/observe/axiom-ai-toolkit-instrumentation).

## Additional Resources

- [Axiom AI Engineering Documentation](https://axiom.co/docs/ai-engineering/overview)
- [Axiom AI TOOLKIT on GitHub](https://github.com/axiomhq/ai)
