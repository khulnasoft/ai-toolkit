...
Arize AX offers first-class OpenTelemetry integration and works directly with the AI TOOLKIT in both Next.js and Node.js environments.
...
First, install the required dependencies for the AI TOOLKIT, OpenTelemetry and OpenInference.

```bash
npm install ai @ai-toolkit/openai @vercel/otel @arizeai/openinference-vercel @opentelemetry/exporter-trace-otlp-proto
```
...
You must set the `experimental_telemetry` flag to true in all calls using the AI TOOLKIT.
...
```bash
npm install ai @ai-toolkit/openai @opentelemetry/sdk-node @arizeai/openinference-vercel @opentelemetry/exporter-trace-otlp-proto @opentelemetry/resources
```
...
```bash
npm install ai @ai-toolkit/openai @opentelemetry/sdk-trace-node @arizeai/openinference-vercel @opentelemetry/exporter-trace-otlp-proto @opentelemetry/resources
```
