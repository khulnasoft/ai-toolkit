...
Braintrust natively supports OpenTelemetry and works out of the box with the AI TOOLKIT, either via Next.js or Node.js.
...
When you call the AI TOOLKIT, make sure to set `experimental_telemetry`:
...
```bash
npm install ai @ai-toolkit/openai braintrust @opentelemetry/sdk-node @opentelemetry/sdk-trace-base zod
```
