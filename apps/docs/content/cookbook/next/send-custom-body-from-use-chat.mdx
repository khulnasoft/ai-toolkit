...
description: Learn how to send a custom body from the useChat hook using the AI TOOLKIT and Next.js
tags: ['next', 'chat']
---
...
<Note>
  ...
  documentation](https://studio.khulnasoft.com/docs/ai-toolkit-ui/chatbot#request-configuration).
</Note>
...
```typescript title='app/page.tsx' {3,7-14}
'use client';
...
```tsx title='app/api/chat/route.ts' {8,11,12,16}
