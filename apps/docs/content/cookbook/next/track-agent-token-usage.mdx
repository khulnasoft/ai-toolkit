...
<Note>
  ...
  documentation](/docs/reference/ai-toolkit-core/tool-loop-agent).
</Note>
...
import { type InferAgentUIMessage, ToolLoopAgent, tool } from 'ai-toolkit';
import { z } from 'zod';
...
```typescript title='ai/agent.ts' {1,15-16}
import {
...
```tsx title='app/api/chat/route.ts' {11-17}
import { convertToModelMessages } from 'ai-toolkit';
import { type AgentUIMessage, agent } from '@/ai/agent';
...
```typescript title='app/page.tsx' {17-19}
'use client';
...
```typescript title='ai/agent.ts' {11-13,21-26}
import {
  type InferAgentUIMessage,
  type LanguageModelUsage,
  ToolLoopAgent,
...
```tsx title='app/api/chat/route.ts' {7-9,13-15}
import { convertToModelMessages } from 'ai-toolkit';
import { type AgentUIMessage, agent } from '@/ai/agent';
...
```typescript title='ai/agent.ts' {9-11,31-40}
import {
  type InferAgentUIMessage,
  type LanguageModelUsage,
  ToolLoopAgent,
