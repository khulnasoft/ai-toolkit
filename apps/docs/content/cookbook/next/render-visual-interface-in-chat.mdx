...
description: Learn how to render visual interfaces in chat using the AI TOOLKIT and Next.js
tags: ['next', 'generative user interface']
---


An interesting consequence of language models that can call [tools](/docs/ai-toolkit-core/tools-and-tool-calling) is that this ability can be used to render visual interfaces by streaming React components to the client.
