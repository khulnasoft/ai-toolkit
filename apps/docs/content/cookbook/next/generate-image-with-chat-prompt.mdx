...
description: Learn how to generate an image with a chat prompt using the AI TOOLKIT and Next.js
tags: ['next', 'streaming', 'chat', 'image generation', 'tools']
---


When building a chatbot, you may want to allow the user to generate an image. This can be done by creating a tool that generates an image using the [`generateImage`](/docs/reference/ai-toolkit-core/generate-image) function from the AI TOOLKIT.
...
```typescript title='tools/generate-image.ts'
