...
description: Learn how to record the final object after streaming an object using the AI TOOLKIT and Node
...
The [`streamObject`](/docs/reference/ai-toolkit-core/stream-object) result contains an `object` promise that resolves to the final object.
