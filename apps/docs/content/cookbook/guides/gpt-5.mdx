...
description: Get started with GPT-5 using the AI TOOLKIT.
...
The [AI TOOLKIT](/) is a powerful TypeScript toolkit for building AI applications with large language models (LLMs) like OpenAI GPT-5 alongside popular frameworks like React, Next.js, Vue, Svelte, Node.js, and more.
...
At the center of the AI TOOLKIT is [AI TOOLKIT Core](/docs/ai-toolkit-core/overview), which provides a unified API to call any LLM. The code snippet below is all you need to call OpenAI GPT-5 with the AI TOOLKIT:
...
Let's explore building a chatbot with [Next.js](https://nextjs.org), the AI TOOLKIT, and OpenAI GPT-5:
...
2. Check out practical examples at [studio.khulnasoft.com/cookbook](/cookbook) to see the SDK in action and get inspired for your own projects.
3. Dive deeper with advanced guides on topics like Retrieval-Augmented Generation (RAG) and multi-modal chat at [studio.khulnasoft.com/cookbook/guides](/cookbook/guides).
