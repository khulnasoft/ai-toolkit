...
AI TOOLKIT development requires PNPM v9 (lockfile version) or higher and Node v20 or higher.
...
1. `cd examples/ai-core` (for AI TOOLKIT Core, or another example folder)
